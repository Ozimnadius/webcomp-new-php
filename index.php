                    ...
                    <div class="index-price__calc">
                        <form class="calc" action="#" method="post">
                            ...
                            <div class="calc__row">
                                ...
                                <div class="calc__fields">
                                    <div class="calc__field">
                                        <input class="calc__checkbox" type="checkbox" id="checkbox0" name="needs[]" value="Уникальный дизайн">
                ...
                <section class="index-seo">
                    ...
                    <form class="index-seo__form" action="#" method="#">
                        <div class="index-seo__items">
                            ...
                            <div class="index-seo__item">
                                <label class="index-seo__label">
                                    <input class="index-seo__input" type="radio" name="seo"
                            ...
                            <div class="index-seo__item">
                                <label class="index-seo__label">
                                    <input class="index-seo__input" type="radio" name="seo" value="ювелирный магазин"
                                           checked>
