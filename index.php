        ...
        <div class="index">
            <div class="container">
                ...
                <section class="index-cat">
                    ...
                    <div class="index-cat__list"><a class="index-cat__item" href="./portfolio.php" title="Промо-сайт" style="background-color:#fdd752">
                            <div class="proportion proportion_1x1"></div>
                            <div class="index-cat__item-title">Промо-сайт</div>
                            <div class="index-cat__item-img"><img class="index-cat__item-pic" src="/images/content/sites/site1.png"></div></a><a class="index-cat__item" href="./portfolio.php" title="Промо-сайт" style="background-color:#013243">
                            <div class="proportion proportion_1x1"></div>
                            <div class="index-cat__item-title">Промо-сайт</div>
                            <div class="index-cat__item-img"><img class="index-cat__item-pic" src="/images/content/sites/site2.png"></div></a><a class="index-cat__item" href="./portfolio.php" title="Промо-сайт" style="background-color:#00a2ff">
                            <div class="proportion proportion_1x1"></div>
                            <div class="index-cat__item-title">Промо-сайт</div>
                            <div class="index-cat__item-img"><img class="index-cat__item-pic" src="/images/content/sites/site3.png"></div></a><a class="index-cat__item" href="./portfolio.php" title="Промо-сайт" style="background-color:#c70541">
                            <div class="proportion proportion_1x1"></div>
                            <div class="index-cat__item-title">Промо-сайт</div>
                            <div class="index-cat__item-img"><img class="index-cat__item-pic" src="/images/content/sites/site4.png"></div></a><a class="index-cat__item" href="./portfolio.php" title="Промо-сайт" style="background-color:#000000">
                            <div class="proportion proportion_1x1"></div>
                            <div class="index-cat__item-title">Промо-сайт</div>
                            <div class="index-cat__item-img"><img class="index-cat__item-pic" src="/images/content/sites/site5.png"></div></a><a class="index-cat__item" href="./portfolio.php" title="Промо-сайт" style="background-color:#bd0808">
                            <div class="proportion proportion_1x1"></div>
                            <div class="index-cat__item-title">Промо-сайт</div>
                            <div class="index-cat__item-img"><img class="index-cat__item-pic" src="/images/content/sites/site6.png"></div></a><a class="index-cat__item" href="./portfolio.php" title="Промо-сайт" style="background-color:#e8b4c6">
                            <div class="proportion proportion_1x1"></div>
                            <div class="index-cat__item-title">Промо-сайт</div>
                            <div class="index-cat__item-img"><img class="index-cat__item-pic" src="/images/content/sites/site7.png"></div></a><a class="index-cat__item" href="./portfolio.php" title="Промо-сайт" style="background-color:#040a1a">
                            <div class="proportion proportion_1x1"></div>
                            <div class="index-cat__item-title">Промо-сайт</div>
