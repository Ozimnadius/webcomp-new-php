                ...
                <div class="container">
                    <div class="site-first__bread">
                        <div class="bread"><a class="bread__item" href="/">Создание сайтов</a><a
                                    class="bread__item active">Промо-сайт</a>
                        </div>
                    </div>
            ...
            <div class="container">
                <section class="site-middle">
                    <div class="site-dev">
                        ...
                        <div class="site-dev__desc">
                            <div class="site-dev__desc-item"><span
                                        ...
                                        class="site-dev__desc-val">Сайт по подбору автомобилей</span></div>
                            <div class="site-dev__desc-item"><span class="site-dev__desc-name">Цель:&nbsp;</span><span
                                        class="site-dev__desc-val">Разработка продающего сайта для увеличения продаж в контекстной рекламе</span>
                            </div>
                        </div>
                                ...
                                <div class="swiper-container site-dev__container">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide site-dev__slide"
                                             data-logo="/images/content/dev/devLogo.png"
                                             data-desc="Сайт по подбору автомобилей"
                                             data-goal="Разработка продающего сайта для увеличения продаж в контекстной рекламе">
                                            <div class="proportion proportion_750x470"></div>
                                            <div class="site-dev__slide-img"><img class="site-dev__slide-pic"
                                                                                  src="/images/content/dev/dev1.jpg">
                                            </div>
                                        </div>
                                        <div class="swiper-slide site-dev__slide"
                                             data-logo="/images/content/dev/logo2.png"
                                             data-desc="Сайт компании по производству сырья для косметики"
                                             data-goal="Разработать сайт для создания имиджа компании в интернете">
                                            <div class="proportion proportion_750x470"></div>
                                            <div class="site-dev__slide-img"><img class="site-dev__slide-pic"
                                                                                  src="/images/content/dev/dev2.jpg">
                                            </div>
                                        </div>
                                        <div class="swiper-slide site-dev__slide"
                                             data-logo="/images/content/dev/logo3.png"
                                             data-desc="Сайт компании по юридической помощи авиапассажирам"
                                             data-goal="Увеличение продаж по дополнительным услугам юридической компании">
                                            <div class="proportion proportion_750x470"></div>
                                            <div class="site-dev__slide-img"><img class="site-dev__slide-pic"
                                                                                  src="/images/content/dev/dev3.jpg">
                                            </div>
                                        </div>
                                        <div class="swiper-slide site-dev__slide"
                                             data-logo="/images/content/dev/logo4.png"
                                             data-desc="Сайт для компании Биофолика"
                                             data-goal="Презентация товаров и услуг бренда с акцентами на индивидуальность">
                                            <div class="proportion proportion_750x470"></div>
                                            <div class="site-dev__slide-img"><img class="site-dev__slide-pic"
                                                                                  src="/images/content/dev/dev4.jpg">
                                            </div>
                                        </div>
                                        <div class="swiper-slide site-dev__slide"
                                             data-logo="/images/content/dev/logo5.jpg"
                                             data-desc="Сайт для детского лагеря"
                                             data-goal="Разработка продающего решения для детского лагеря">
                                            <div class="proportion proportion_750x470"></div>
                                            <div class="site-dev__slide-img"><img class="site-dev__slide-pic"
                                                                                  src="/images/content/dev/dev5.jpg">
                                            </div>
                                        </div>
                                    </div>
                                </div>
                        ...
                        <div class="site-dev__title">Создание сайта визитки включает</div>
                        ...
                        <div class="site__banner">
                            <div class="banner">
                                ...
                                <div class="banner__right">
                                    <div class="banner__text">Готовые решение под вашу<br>тематику от<b> 35 000 Р</b>
                                    </div>
                    ...
                    <div class="site-cost">
                        ...
                        <div class="site-cost__sub">Заполните бриф онлайн для расчёта точной стоимости промо сайта<br>или
                    ...
                    <div class="container2">
                        ...
                        <div class="bottom__why">
                            <div class="why">
                                ...
                                <div class="why__title"><h2 style="font-size: 40px;font-weight: 300;">Сайт визитка -
                                        инструмент для презентации</h2></div>
                                <div class="why__content">
                                    <p>
                                        Сайт Визитка – это отличный инструмент для презентации как компании, так и
                                        персоны в
                                        интернете. Такой вид сайта быстро создаётся и настраивается. Сайт будет работать
                                        на Вас
                                        круглосуточно, без перерывов и выходных, рассказывая о вас и ваших персональных
                                        услугах,
                                        позволит продавать товары или собирать целевую аудиторию в одном месте. Если Вам
                                        нужен
                                        недорогой сайт визитка, соответствующий всем стандартам - заказывайте в нашей
                                        студии
                                        web-comp. В комплекте вы получаете ряд бесплатных приятных бонус такие как:
                                        подбор и
                                        регистрация домена, оплаченный хостинг на 2 месяца и техническую поддержку.
                                    </p>
                                    <h2>Почему стоит заказать у нас</h2>
                                    <ul>
                                        <li>Включено: Домен на 1 год</li>
                                        <li>Включено: Хостинг на 2 месяца</li>
                                        <li>Техническая поддержка</li>
                                        <li>Индивидуальный подход к проекту</li>
                                        <li>Защита сайта от DDos-атак</li>
                                        <li>Комплексный подход к задаче</li>
                                    </ul>
                                    <ul>
                                        <li>Рекомендации по развитию</li>
                                        <li>Проводим аудит конкурентов</li>
                                        <li>Используем только новые стандарты</li>
                                        <li>Соблюдаем сроки</li>
                                        <li>Генерируем контент</li>
                                        <li>Помогаем наладить рабочие процессы</li>
                                    </ul>
                                    <h2>Отвечаем за эффективность</h2>
                                    <p>
                                        Почему у нас дороже? При разработке сайта-визитки нужно учитывать дополнительные
                                        услуги, которые потребуются при наличии полноценного сайта в интернете. К ним
                                        относится
                                        регистрация доменного имени ( http://сайт.ru ), также сайт должен быть
                                        расположен на
                                        сервере в интернете для всеобщей доступности, сервер должен отвечать
                                        определённым
                                        требованиям, которые влияют на качество работы ресурса.В большинстве случаев
                                        понадобятся
                                        консультации по работе с сайтом, его развитию и привлечению клиентов. Все работы
                                        по аудиту
                                        также включены в стоимость создания сайта.
                                    </p>
                                    <p>
                                        Комплексный подход - это экономия вашего времени, мы подготовим максимум
                                        информации
                                        по вашей тематике, которую в дальнейшем вы сможете использовать при развитии
                                        ресурса.
                                        Доверив выполнение работ профессионалам вы получаете быстрое и качественное
                                        выполнение
                                        поставленных задач и достижение целей.
