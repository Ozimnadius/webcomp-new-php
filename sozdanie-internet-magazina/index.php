        ...
        <div class="site">
            <section class="site-first">
                <div class="container">
                    ...
                    <h1 class="site-first__title">Создание интернет-магазина под ключ
                    </h1>
                    ...
                    <div class="site-dev">
                        ...
                        <div class="site-dev__desc">
                            ...
                            <div class="site-dev__desc-item"><span class="site-dev__desc-name">Цель:&nbsp;</span><span
                                        class="site-dev__desc-val">Разработка масштабного магазина сантехники с подключение базы склада и систем оплаты и доставки</span>
                            </div>
                        </div>
                                ...
                                <div class="swiper-container site-dev__container">
                                    <div class="swiper-wrapper">
                                        <div class="swiper-slide site-dev__slide"
                                             ...
                                             data-goal="Разработка масштабного магазина сантехники с подключением базы склада и системой оплаты и доставки">
                        ...
                        <h2 class="site-dev__title" style="font-weight: 400;">В разработку интернет-магазина входит</h2>
                        ...
                        <section class="theme-price">
                            <h2 class="theme-price__title">Стоимость интернет-магазина</h2>
                    ...
                    <div class="container2">
                        ...
                        <div class="bottom__why">
                            <div class="why">
                                ...
                                <div class="why__title"><h2 style="font-size: 57px;font-weight: 300;">Услуги по созданию интернет-магазина</h2></div>
                                <div class="why__content">
                                    ...
                                    <p>
                                        ...
                                        дизайнеры,
                                        программисты, тестировщики, контент-менеджеры. Обращаясь в Web-Comp, вы
                                        гарантированно
                                    ...
                                    <p>В студии Web-Comp на создание интернет магазина цена формируется в зависимости
                                        от выбранного объема, функционала и конечной цели сайта - от небольшого семейного бизнеса до крупнейшего онлайн гипермаркета.</p>
                                    ...
                                    <ul>
                                        ...
                                        <li>Для ведения бизнеса достаточно небольшого офиса</li>
                                    ...
                                    <p>Изучая портфолио, обращайте внимание на визуальную часть и на функциональность макетов.
                                    ...
                                    <p>Маркетинговая сторона разработки предполагает настройку взаимодействия с
                                        ...
                                        Не лишним будет создать специальный блок, мотивирующий поделиться ссылкой в соц.
                                    ...
                                    <p>Прежде, чем заказывать создание интернет магазина, спросите, сможет ли подрядчик
                                        ...
                                        версию. Обязательно обговорите сроки выполнения заказа, выясните, какие
                                    ...
                                    <p>Необходимо проверить соответствие верстки утвержденным дизайн макетам страниц. Сайт должен корректно
                                        отображаться на всех устройствах — в противном случае работа считается
                                    ...
                                    <h3>Почему стоит выбрать магазин на CMS 1С-Битрикс</h3>
                                    <p>1С-Битрикс занимает лидирующие позиции среди систем контроля содержимого
                                    ...
                                    <h2>Основные преимущества Битрикса следующие:</h2>
                                    <ul>
                                    ...
                                    <p>Конечно, для низкобюджетных проектов использование Битрикса может показаться неразумным, при этом для
                                        разработки крупного интернет магазина система подходит как нельзя лучше. Стоит отметить, что при запланированном на будущее расширении и масштабировании проекта, CMS 1C-Битрикс подойдет для проектов любого типа и объема.</p>
                                    ...
                                    <ul>
                                        ...
                                        <li>Формирование ассортимента</li>
                                        <li>Публикация контента</li>
                                        <li>Применение актуальных механизмов привлечения покупателей</li>
                                        <li>Настройка способов обработки заказов</li>
                                    </ul>
                                    <ul>
                                        <li>Интеграция систем для приема платежей</li>
                                        <li>Организация доставки товаров</li>
                                        <li>Организация работы с возвратами</li>
                                    ...
                                    <p>
                                        ...
                                        довольно сложное дело. Важно понимать, что все усилия здесь оправдываются положительным результатом
                                        ...
                                        номерам 8 (800) 333-45-98 или +7 (495) 150-45-98. Заявки также принимаются на
                                        электронную почту info@web-comp.ru. Если вы хотите подробнее обсудить все
                                        аспекты проекта, мы ждем вас в гости - наш адрес: Москва, ул. Нижние Поля, 31.
