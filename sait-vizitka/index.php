            ...
            <section class="site-first">
                <div class="container">
                    <div class="site-first__bread">
                        <div class="bread"><a class="bread__item" href="/">Создание сайтов</a><a class="bread__item active">Сайт-визитка</a>
                        </div>
                    </div>
                ...
                <section class="site-middle">
                    <div class="site-dev">
                        ...
                        <div class="site-dev__desc">
                            <div class="site-dev__desc-item"><span class="site-dev__desc-name">Описание:&nbsp;</span><span class="site-dev__desc-val">Сайт по подбору автомобилей</span></div>
                            <div class="site-dev__desc-item"><span class="site-dev__desc-name">Цель:&nbsp;</span><span class="site-dev__desc-val">Разработка продающего сайта для увеличения продаж в контекстной рекламе</span></div>
                        </div>
                        ...
                        <h1 class="site-dev__title">Создание сайта визитки</h1>
                        ...
                        <section class="theme-price">
                            <h2 class="theme-price__title">Стоимость сайта визитки</h2>
...
<!--                            </div>-->
                        ...
                        <div class="site__banner">
                            <div class="banner">
                                ...
                                <div class="banner__right">
                                    <div class="banner__text">Создадим запоминающийся<br><b>сайт для вашей ниши!</b></div>
                    ...
                    <div class="site-cost">
                        <h3 class="site-cost__title" style="font-weight: 300;">Сколько стоит ваш промо сайт</h3>
                        <div class="site-cost__sub">Заполните бриф онлайн для расчёта точной стоимости промо сайта<br>или загрузите свое ТЗ для оценки</div>
                        ...
                        <div class="bottom__why">
                            <div class="why">
                                ...
                                <div class="why__content">
                                    <p>
                                        Студия Web-comp предлагает разработку сайтов. У нас можно заказать создание сайта-визитки, который обеспечит эффективное продвижение вашей компании в сети, повысит уровень узнаваемости фирмы и ежедневно приводить к вам новых клиентов.
                                    </p>
                                    <p>Сайт-визитка – небольшой веб-ресурс, который может содержать следующие страницы:</p>
                                    <ul>
                                        <li>информация о компании, история, конкурентные преимущества;</li>
                                        <li>описание основных видов дейтельности;</li>
                                        <li>контакты;</li>
                                        <li>презинтация фирмы.</li>
                                    </ul>
                                    <p>Для повышения конверсии на сайт могут быть добавлены формы обратного звонка, заказа, чат с представителем фирмы и прочие сервисы, способствующие повышению комуникации с клиентами.</p>
									<h2>Особенности нашего продукта</h2>
									<p>Если вам нужен качественный сайт-визитка, позволяющий выделиться среди конкурентов, вам помогут наши штатные дизайнеры и программисты студии. Мы имеем большой опыт в области веб-разработки, постоянно повышаем квалификацию, изучаем новые технологии и гарантируем своим клиентам:</p>
									<ul>
                                        <li>сайт будет полностью соответствующих последним требованиям поисковых систем;</li>
                                        <li>корректно отображающихся на любом устройстве;</li>
                                        <li>сайт будет удобен для пользователей;</li>
                                        <li>вызывать доверие целевой аудитории.</li>
                                    </ul>
                                    <h2>Наши преимущества</h2>
                                    <p>
                                        Мы создаем сайты-визитки под ключ, заключая договор со студией, вы получаете полностью готовый веб-ресурс, размещенный на надежном хостинге. В комплекс услуг входит:
                                    </p>
									<ul>
                                        <li>анализ конкурентов;</li>
                                        <li>разработка уникальной концепции;</li>
                                        <li>создание дизайна;</li>
                                        <li>выбор и регистрация доменного имени;</li>
                                    </ul>
									<ul>
                                        <li>работы по верстке и программированию;</li>
                                        <li>размещение контента;</li>
                                        <li>внедрение защиты от DDOS-атак;</li>
                                        <li>установка на хостинг.</li>
                                    </ul>
                                    <p>В стоимость разработки также входит техническая поддержка, разработка стратегии развития и продвижения веб-ресурса.
                                    </p>
                                    <p>Наша студия Web-Comp создает эффективные порталы с высокой конверсией. Специалисты компании отлично знают законы маркетинга, способы эффективной сео-оптимизации, методы привлечения целевой аудитории.</p>
                                    <p>Мы гарантируем индивидуальный подход к каждому клиенту. И это не просто слова. Наши специалисты погружаются в тематику, изучают сайты конкурентов, анализируют их слабые сильные места и помогают разработать уникальную концепцию и сформировать УТП.</p>
                                    <p>За время работы над сайтом мы собираем множество материалов, которые впоследствии пригодятся вам для продвижения и развития вашего веб-портала.</p>
                                    <h2>Как начать сотрудничество?</h2>
                                    <p>Мы не предлагаем своим клиентам «самые низкие цены», потому что не штампует «визитки» по единому шаблону, а создаем штучный продукт, учитывающий все особенности вашей компании, а также потребности целевой аудитории. Сайты, созданные мастерами студии Web-comp, - это мощный маркетинговый инструмент, позволяющий быстро повысить продажи и вывести бизнес на новый уровень.</p>
                                    <p>Заказать разработку сайта визитки под ключ вы сможете, оставив заявку онлайн или связавшись с менеджерами по электронной почте либо по телефону. Наши администраторы попросят заполнить бриф, рассчитают стоимость заказа и определят сроки проведения работ.</p>
                                </div>
                            </div>
                        </div>
