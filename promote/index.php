                                ...
                                <div class="form__row">
                                    ...
                                    <div class="form__field">
                                        <select class="select" name="region">
                                            ...
                                            <option>Санкт-Петербург и область</option>
                                            <option>Другой город РФ</option>
                                            <option>Вся  Россия</option>
                                        </select>
                                    </div>
                                    <div class="form__field">
                                        <select class="select" name="thematics">
                                            <option disabled selected>Ваше направление</option>
                    ...
                    <div class="container2">
                        ...
                        <div class="bottom__why">
                            <div class="why">
                                ...
                                <h2><div class="why__title">Продвижение в WEB-COMP</div></h2>
                                <div class="why__content">
									...
									<h2>Цены на продвижение сайтов</h2>
