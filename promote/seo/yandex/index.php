        ...
        <div class="seo">
            <section class="seo-first">
                <div class="container">
                    ...
                    <div class="seo-first__title"><h1 style="font-size: 50px; font-weight: 300; line-height: 1.2;">Продвижение сайта в топ Яндекса</h1></div>
            ...
            <div class="container3">
                    ...
                    <div class="seo-desc__row">
                        <div class="seo-desc__left">
                            <div class="seo-desc__block content">
                                <h2 style="font-size: 30px; margin-bottom: 30px; font-weight: 400;">Продвинем сайт в Топ-10 Яндекса </h2>
                ...
                <section class="seo-price">
                    <div class="seo-price__title">Стоимость продвижения в Яндексе</div>
                    ...
                    <div class="container2">
                        ...
                        <div class="bottom__why">
                            <div class="why">
                                ...
                                <div class="why__title"><h3 style="font-size: 57px; font-weight: 300; text-transform: uppercase; text-align: center; margin-bottom: 4.54545vh;">Мы учитывает все алгоритмя Яндекса</h3></div>
								...
								<h2>Полезные инструменты, которые мы подключаем</h2>
									...
									<ul>
										...
										<li>Аналитика - мы предоставляем полную аналитику и прозрачную схуму работ. Готовы предоставить отчёт о всех выполненных работах и отчитатся за бюджет.</li>
									</ul>
									<p>Услуги аудита клиенты студии получают Включено. Комплексный подход, анализ по 130 показателям позволяют безошибочно определять слабые стороны площадки, находить эффективные инструменты для их устранения. </p>
