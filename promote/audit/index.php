        ...
        <div class="seo">
                ...
                <div class="container">
                    <div class="seo-first__bread">
                        <div class="bread">
                            ...
                            <a class="bread__item active">Маркетинговый аудит</a>
                            
                        </div>
                    </div>
                    <div class="seo-first__title"><h1 style="font-size: 50px; font-weight: 300; line-height: 1.2;">Полный маркетинговый аудит<br>за 14 дней</h1></div>
                    <div class="seo-first__subtitle">Узнайте свои сильные и слабые стороны<br>найдите зоны роста</div>
                    <button class="seo-first__button callorderOpen" data-formId="7" type="button">
                        <div class="btn">
            ...
            <div class="container3">
                    ...
                    <div class="seo-desc__row">
                        <div class="seo-desc__left">
                            <div class="seo-desc__block content">
                                <h2 style="font-size: 30px; margin-bottom: 30px; font-weight: 400;">Покажем прозрачность и многогранность направления</h2>
                                <p>Анализировать интернет-ресурс нужно для того, чтобы оценить эффективность стратегии продвижения, изучить рынок, определить его основные рабочие процессы. Пример – площадка есть, она имеет красивый дизайн и грамотное наполнение, но продажи стоят на месте. Нужно провести маркетинговый аудит сайта – он покажет слабые места текущей стратегии, позволит внести в нее грамотные корректировки, выполнить правильный редизайн. В итоге владелец получит прибыльный, эффективный ресурс для решения текущих бизнес-задач.</p>
                                <p>Другие задачи, которые решает маркетинговый анализ сайта:</p>
								<ul>
								<li>получение полного представления об актуальной рыночной ситуации;</li>
								<li>выявление текущих препятствий к росту продаж;</li>
								<li>определение реальных перспектив для развития бизнеса;</li>
								<li>составление плана по улучшению онлайн-представительства, контента на нем;</li>
								<li>разработка маркетинговой стратегии на ближайший период времени.</li>
								</ul>
								<p>Результаты данного анализа позволят улучшить качество восприятия товаров, услуг потенциальными партнерами, клиентами, в несколько раз повысить продажи.</p>
                            </div>
                            <div class="seo-desc__block content">
                                <h3>Проверяем более 100 показателей ресурса</h3>
                                <p>Разделим их на следующие направления:</p>
								<ul>
									<li>Анализ бизнеса заказчика – его преимуществах и недостатках, реализуемых стратегических решениях, порядка взаимодействия с аудиторией.</li>
									<li>Изучение деятельности конкурентов – преимуществ, особенностей развития, реперзентации, способов подачи материала, применения веб-инноваций, ценовую политику. Площадка клиентов должна выглядеть не хуже, чем у любого конкурента. </li>
									<li>Тест посещаемости – источники посетителей, другие данные о трафике, информация по регионам, времени перехода, популярным страницам, определение возможных причин спада трафика или времени посещения.</li>
									<li>Анализ ресурса - выявление ошибок оптимизации или работы, проверка коректности обмена информации с поисковыми системами.</li>
									<li>Анализ ЦА – возрастная категория, пол, социальное положение пользователей, структурные особенности аудитории, принципы соотношения новых, старых клиентов</li>
								</ul>
                            </div>
                            <div class="seo-desc__block content">
                            </div>
                            <button class="seo-desc__button button button_red promotionOpen" type="button">Получить консультацию</button>
                        </div>
                ...
                <section class="seo-cats">
                    ...
                    <div class="seo-price__title">Стоимость аудита</div>
                    ...
                    <div class="container2">
                        ...
                        <div class="bottom__why">
                            <div class="why">
                                ...
                                <div class="why__title"><h2 style="font-size: 50px; margin-bottom: 20px; font-weight: 300;">Почему маркетинговый аудит необходим?</h2></div>
                                <div class="why__content">
									<p>Практически 80% онлайн-ресурсов реализуют имеющийся потенциал на 30%. В большинстве случаев конверсия составляет 0.5% - 1%. У раскрученных и оптимизированных площадок данный параметр составляет 4% - 12% Бесплатный аудит сайта мы делаем при заказе услуги комплексного продвижения, в остальных случаях он проводится за дополнительную плату. Средний срок проверки – 2 недели, и зависит от сферы аудита и ресурса заказчика. </p>
									<p>Заказать маркетинговый аудит сайта можно для формирования полной информации по проекту. Предоставляются рекомендации по наращиванию продаж. После проверки клиенту предоставляется отчет по параметрам, использованным в процессе исследования, рекомендации для повышения эффективности работы площадки. Учитывается максимальный перечень показателей.</p>
									<p>После учета всех рекомендаций сайт начнет лучше продавать, и бизнес принесет максимальный доход. Чтобы узнать стоимость аудита сайта или оформить заказ, оставьте заявку.</p>
								</div>
                            </div>
                        </div>
