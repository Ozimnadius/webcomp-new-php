                ...
                <div class="container">
                    <div class="seo-first__bread">
                        <div class="bread">
                            ...
                            <a class="bread__item active">Турфирмы</a>
                        </div>
                    </div>
                    <div class="seo-first__title">Продвижение сайта турфирмы<br>с оплатой за результат</div>
                    ...
                    <div class="seo-desc__row">
                        <div class="seo-desc__left">
                            <div class="seo-desc__block content">
                                <h3>Продвижение сайтов туроператора</h3>
                                <p>Успех раскрутки компании  в сети зависит не только от вложенных средств, но в большей мере, 
								от разработки правильной стратегии с учетом специфики деятельности. 
								В студии Web-Comp вы сможете заказать продвижение и рекламу сайта турфирмы под ключ.
								Наши специалисты имеют большой опыт, используют надежные методы и креативно подходят к решению поставленных задач.</p>
								</div>

                            <div class="seo-desc__block content">
                                <h3>Что важно учитывать?</h3>
                                <p>В области туризма высокий уровень конкуренции. Кроме того, многие путешественники не склонны доверят незнакомым туроператорам. Поэтому наши специалисты работают сразу по нескольким направлениям:</p>
								<ul>
									<li>seo-оптимизация и продвижение;</li>
									<li>повышение уровня узнаваемости и доверия (для этих целей используются группы в социальных сетях);</li>
									<li>формирование положительного имиджа (размещение отзывов и статей на сторонних ресурсах);</li>
									<li>методы быстрого привлечения клиентов (баннерная и контекстная).</li>
								</ul>

								<br>
								<p>Мы постоянно отслеживаем результаты и формируем для заказчиков отчеты, при необходимости, своевременно  корректируем стратегию и гарантируем достижение желаемого результата в минимально возможные сроки. </p>
