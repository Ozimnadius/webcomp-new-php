                ...
                <div class="container">
                    <div class="seo-first__bread">
                        <div class="bread">
                            ...
                            <a class="bread__item active">Книги</a>
                        </div>
                    </div>
                    <div class="seo-first__title">Продвижение сайта с книгами<br>с оплатой за результат</div>
                    ...
                    <div class="seo-desc__row">
                        <div class="seo-desc__left">
                            <div class="seo-desc__block content">
                                <h3>Продвижение интернет-магазина книг</h3>
                                <p>Важно не только создать веб-сайт в сети, но и организовать его правильное развитие в интернет-пространстве 
								для расширения количества потенциальной аудитории, для повышения популярности предлагаемой продукции. 
								Наша фирма готова предложить клиентам услуги в области продвижения сайта продажи книги. 
								Комплексный подход к решению поставленной задачи, использование современных инструментов, опытные технические 
								специалисты - залог эффективной рекламы в интернете для сайта продаж книг.</p>
								</div>
                            ...
                            <div class="seo-desc__block content">
								...
								<ul>
                                    <li>полный анализ веб-ресурса для подбора подходящих инструментов, повышающих популярность портала в сети среди потенциальных клиентов;<li>
                                    <li>доступные цены на услуги;</li>
                                    <li>рабочие советы по дальнейшему развитию веб-сайта.</li>
							    </ul>
								<br>
								<p>Заказать продвижения презентации книг можно непосредственно в компании через менеджера. 
								Договор составляется только после детального обсуждения всех путей дальнейшего сотрудничества, 
								после разработки стратегии по выдвижению веб-сайта в топ выдачи поисковых систем. 
								ля консультации просто свяжитесь с нами по телефону.</p>
								</div>
