                ...
                <div class="container">
                    <div class="seo-first__bread">
                        <div class="bread">
                            ...
                            <a class="bread__item active">Автосервис</a>
                        </div>
                    </div>
                    <div class="seo-first__title">Продвижение услуг автосервиса<br>с оплатой за результат</div>
                    ...
                    <div class="seo-desc__row">
                        <div class="seo-desc__left">
                            <div class="seo-desc__block content">
                                <h3>Продвижение услуг автосервиса</h3>
                                <p>Для успеха любого проекта нужна качественная реклама. Сфера авто-обслуживания не исключение. 
								WEB-COMP займется продвижением сайта автосервиса под ключ и увеличит поток клиентов.</p>
								</div>

                            <div class="seo-desc__block content">
                                <h3>Профессиональный подход</h3>
                                <p>Процесс нашей работы делится на следующие этапы:</p>
								<ul>
                                    <li>Аудит ниши, конкурентской базы. Выявление запрашиваемых ключей пользователей.<li>
                                    <li>Оформление сайта, наполнение информацией. Главное дать понять посетителю, почему стоит поехать в сервис именно к вам.</li>
                                    <li>Активно поддерживаем социальные сети, анализируем аккаунты конкурентов. Настраиваем таргет на клиентов конкурентов.</li>
									<li>Регистрация сервисов геолокации.</li>
									<li>Реклама отдельных услуг</li>
									<li>Настройка контекстной рекламы.</li>
									<li>Исследование тематических форумов для размещения рекламы на них.</li>
							    </ul>
								<br>
								<p>Внимание уделяется конкретизации анализа запросов. Настройка уточненных данных удваивает вероятность приобрести постоянного клиента.</p>
								<p>Грамотная реклама автосервиса в интернете поможет:</p>
								<ul>
									<li>Увеличить клиентскую базу.</li>
									<li>Обеспечить регулярный рост обращений.</li>
									<li>Занять первые строки в поисковой системе.</li>
								</ul>
								<br>
								<p>Свяжитесь с нами и наши специалисты подробно проконсультируют вас, укажут нюансы и посоветуют выгодные стратегии развития проекта.</p>
								</div>
