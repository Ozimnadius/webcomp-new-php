        ...
        <div class="search-result">
            <div class="container3">
                ...
                <div class="search-result__pag">
                    <a href="/search-result.php" class="search-result__pag-start" title="В начало">
                        <svg class="search-result__pag-svg">
                            <use xlink:href="/images/icons/sprite.svg#start"></use>
                        </svg>
                    </a>
                    <a href="/search-result.php" class="search-result__pag-prev" title="Предыдущая">
                        <svg class="search-result__pag-svg">
                            <use xlink:href="/images/icons/sprite.svg#prev"></use>
                        </svg>
                    </a>
                    <a href="/search-result.php" class="search-result__pag-item">
                        3
                    </a>
                    <a href="/search-result.php" class="search-result__pag-item active">
                        4
                    </a>
                    <a href="/search-result.php" class="search-result__pag-item">
                        5
                    </a>
                    <a href="/search-result.php" class="search-result__pag-next" title="Следующая">
                        <svg class="search-result__pag-svg">
                            <use xlink:href="/images/icons/sprite.svg#next"></use>
                        </svg>
                    </a>
                    <a href="/search-result.php" class="search-result__pag-end" title="В конец">
                        <svg class="search-result__pag-svg">
