                ...
                <div class="container">
                    <div class="promote-first__wrapper">
                        <div class="promote-first__bread">
                            <div class="bread"><a class="bread__item" href="./">Главная</a><a class="bread__item active">Продвижение</a>
                            </div>
                        </div>
                        ...
                        <div class="promote-first__subtitle">Увеличим Ваши продажи, количество звонков, заявок<br>и заказов с сайта за счет роста целевого трафика и вывода Вашего сайта<br>в ТОП-10 Яндекса и Google</div>
            ...
            <div class="container3">
                <section class="promote-price">
                    ...
                    <div class="promote-price__row">
                        <div class="promote-price__col">
                            <div class="promote-price__block">
                                ...
                                <div class="promote-price__list">
                                    <a class="promote-price__item" href="/promote/seo/result.php">С оплатой за результат</a>
                                    <a class="promote-price__item" href="/promote/seo/traffic.php">С оплатой за трафик</a>
                                    <a class="promote-price__item" href="/promote/seo/ecommerce.php">Продвижение интеренет-магазина</a>
                                    <a class="promote-price__item" href="/promote/seo/company.php">SEO продвижение компании</a>
                                    <a class="promote-price__item" href="/promote/seo/yandex.php">Продвижение в Яндекс</a>
                                    <a class="promote-price__item" href="/promote/seo/google.php">Продвижение в Google</a>
                                    <a class="promote-price__item" href="/promote/seo/optimization.php">SEO оптимизация</a>
                        ...
                        <div class="promote-price__col">
                            <div class="promote-price__block">
                                <a class="promote-price__block-title" href="/promote/thematics.php">Продвижение по тематике</a>
                                <div class="promote-price__list">
                                    <a class="promote-price__item" href="/promote/thematics/autoparts.php">Автозапчасти</a>
                                    <a class="promote-price__item" href="/promote/thematics/accountant.php">Бухгалтерские услуги</a>
                                    ...
                                    <a class="promote-price__item" href="/promote/thematics/furniture.php">Мебельный магазин</a>
                                    <a class="promote-price__item" href="/promote/thematics/repair.php">Ремонтные услуги</a>
                                    <a class="promote-price__item" href="/promote/thematics/building.php">Строительная компания</a>
                        ...
                        <div class="promote-price__col">
                            <div class="promote-price__block">
                                <a class="promote-price__block-title" href="/promote/reklama.php">Контекстная реклама</a>
                                <div class="promote-price__list">
                            ...
                            <div class="promote-price__block">
                                <a class="promote-price__block-title" href="/promote/reklama.php">Маркетинговый аудит</a>
                                <div class="promote-price__list">
                                </div>
                                <div class="promote-price__price">от 39 920 Р</div>
                            </div>
                        ...
                        <div class="promote-price__col">
                            <div class="promote-price__block">
                                <a class="promote-price__block-title" href="/promote/smm.php">Продвижение в сой. сетях</a>
                                <div class="promote-price__list">
                ...
                <section class="promote-result">
                    ...
                    <div class="promote-result__result">
                        <div class="promote-result__list numbers">
                ...
                <section class="promote-work">
                    <div class="promote-work__title"><img class="promote-work__title-img" src="/images/content/promoteWork.png"></div>
                    <div class="promote-work__wrapper">
                        <div class="promote-work__list">
                            <div class="promote-work__item">
                                <div class="promote-work__number">
                                    <div class="promote-work__number-val">01</div><img class="promote-work__number-img" src="/images/content/promote/pWork1.svg">
                                </div>
                            ...
                            <div class="promote-work__item">
                                <div class="promote-work__number">
                                    <div class="promote-work__number-val">02</div><img class="promote-work__number-img" src="/images/content/promote/pWork2.svg">
                                </div>
                                <div class="promote-work__desc">
                                    <div class="promote-work__desc-text">Разработка стратегии
                                        продвижения сайта</div>
                                    <div class="promote-work__desc-arrow">
                                        <div class="arrow">
                                            <div class="arrow__line"></div>
                                            <div class="arrow__triangle"></div>
                            ...
                            <div class="promote-work__item">
                                <div class="promote-work__number">
                                    <div class="promote-work__number-val">03</div><img class="promote-work__number-img" src="/images/content/promote/pWork3.svg">
                                </div>
                                <div class="promote-work__desc">
                                    <div class="promote-work__desc-text">Анализ результата
                                        проделанных работ</div>
                                    <div class="promote-work__desc-arrow">
                                        <div class="arrow">
                                            <div class="arrow__line"></div>
                                            <div class="arrow__triangle"></div>
                            ...
                            <div class="promote-work__item">
                                <div class="promote-work__number">
                                    <div class="promote-work__number-val">04</div><img class="promote-work__number-img" src="/images/content/promote/pWork4.svg">
                                </div>
                                <div class="promote-work__desc">
                                    <div class="promote-work__desc-text">Внесение корректировок
                                        и достижение результата</div>
                                    <div class="promote-work__desc-arrow">
                                        <div class="arrow">
                                            <div class="arrow__line"></div>
                                            <div class="arrow__triangle"></div>
                ...
                <section class="promote-rec">
                    ...
                    <div class="promote-rec__list"><a class="promote-rec__item" href="/" download>
                            ...
                            <div class="promote-rec__name">Рекомендательное письмо</div></a>
                    </div>
                </section>
            </div>
