        ...
        <div class="port bosh">
            <section class="port-lap">
                ...
                <div class="port-lap__bgvideo">
                    <video autoplay muted loop class="port-lap__bgvideo-video" src="/images/content/portfolio/project5/videoplayback.mp4" poster="/images/content/portfolio/project5/bg.jpg">
            ...
            <div class="container3">
                ...
                <div class="port-desc">
                    ...
                    <div class="port-desc__sub">
                        Крупный онлайн магазин с широким ассортиментов бытовых оборудований, для сада и мелкого ремонта
                    </div>
                    <!-- END subtitle -->
                        ...
                        <div class="port-proj__block">
                            ...
                            <div class="port-proj__list">
                                <div class="port-proj__item">
                                    ...
                                    <div class="port-proj__item-desc">
                                        Список моделей каждой категории изображены специальными иконками и названием, при наведении иконки закрашиваются
                                    </div>
                                </div>
                            </div>
                            <!-- END list -->
