...
<main class="page page_second">
    ...
    <main class="main">
        <div class="port santehnika">
            <section class="port-lap">
                <div class="port-lap__bgvideo">
                    <video autoplay muted loop class="port-lap__bgvideo-video"
                           src="/images/content/portfolio/project9/videoplayback.mp4"
                           poster="/images/content/portfolio/project9/bg.jpg">
                        <source src="/images/content/portfolio/project9/videoplayback.mp4" type="video/mp4">
                    </video>
                </div>
                            ...
                            <div class="port-lap__container">
                                ...
                                <div class="port-lap__before">
                                    ...
                                    <div class="port-lap__before-wrap"><img class="port-lap__img"
                                                                            src="/images/content/portfolio/project9/before.jpg">
                                    </div>
                                </div>
                                <div class="port-lap__after"><img class="port-lap__img"
                                                                  src="/images/content/portfolio/project9/after.jpg">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container3">
                ...
                <div class="port-desc">
                    ...
                    <div class="port-desc__logo">
                        <img class="port-desc__logo-img" src="/images/content/portfolio/project9/logo.png"></div>
                    <!-- END logo -->

                    <!-- title -->
                    <h1 class="port-desc__title">
                        Создание интернет-магазина сантехники
                    </h1>
                    <!-- END title -->

                    <!-- subtitle -->
                    <div class="port-desc__sub">
                        Разработка гипермаркета сантехники с умным каталогом и синхронизацией с базой из 80 поставщиков.<br>
                        ...
                        <div class="swiper-container port-slider__container">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide port-slider__slide">
                                    <img class="port-slider__img" src="/images/content/portfolio/project9/slide1.jpg">
                                </div>
                                <div class="swiper-slide port-slider__slide">
                                    <img class="port-slider__img" src="/images/content/portfolio/project9/slide2.jpg">
                                </div>
                                <div class="swiper-slide port-slider__slide">
                                    <img class="port-slider__img" src="/images/content/portfolio/project9/slide3.jpg">
                                </div>
                                <div class="swiper-slide port-slider__slide">
                                    <img class="port-slider__img" src="/images/content/portfolio/project9/slide4.jpg">
                                </div>
                                <div class="swiper-slide port-slider__slide">
                                    <img class="port-slider__img" src="/images/content/portfolio/project9/slide5.jpg">
                                </div>
                                <div class="swiper-slide port-slider__slide">
                                    <img class="port-slider__img" src="/images/content/portfolio/project9/slide6.jpg">
                                </div>
                                <div class="swiper-slide port-slider__slide">
                                    <img class="port-slider__img" src="/images/content/portfolio/project9/slide7.jpg">
                                </div>
                ...
                <div class="port-proj port-proj_1">
                    ...
                    <div class="port-proj__left">
                        <div class="port-proj__img">
                            <img class="port-proj__img-img" src="/images/content/portfolio/project9/project.jpg">
                        </div>
                    </div>
                    <!-- END left -->
                ...
                <div class="port-proj port-proj_2">
                    ...
                    <div class="port-proj__left">
                        <div class="port-proj__img">
                            <img class="port-proj__img-img" src="/images/content/portfolio/project9/project2.jpg">
                        </div>
                    </div>
                    <!-- END left -->
                ...
                <div class="port-proj port-proj_3">
                    ...
                    <div class="port-proj__left">
                        <div class="port-proj__img">
                            <img class="port-proj__img-img" src="/images/content/portfolio/project9/project3.jpg">
                        </div>
                    </div>
                    <!-- END left -->
                ...
                <div class="port-proj port-proj_4">
                    ...
                    <div class="port-proj__left">
                        <div class="port-proj__img">
                            <img class="port-proj__img-img" src="/images/content/portfolio/project9/project4.jpg">
                        </div>
                    </div>
                    <!-- END left -->
                ...
                <div class="port-proj port-proj_5">
                    ...
                    <div class="port-proj__left">
                        <div class="port-proj__img">
                            <img class="port-proj__img-img" src="/images/content/portfolio/project9/project5.jpg">
                        </div>
                    </div>
                    <!-- END left -->
                ...
                <div class="port-pages">
                    ...
                    <div class="port-pages__imgs">
                        <img class="port-pages__img" src="/images/content/portfolio/project9/pages.png"></div>
                ...
                <div class="port-adapt">
                        ...
                        <div class="port-adapt__list">
                            <div class="port-adapt__item">
                                ...
                                <div class="port-adapt__item-img">
                                    <img src="/images/content/portfolio/project9/tablet.png" alt=""
                            ...
                            <div class="port-adapt__item">
                                <!-- img -->
                                <div class="port-adapt__item-img">
                                    <img src="/images/content/portfolio/project9/phone.png" alt=""
                                         class="port-adapt__item-pic">
                                </div>
                                <!-- END img -->
                    ...
                    <div class="port-adapt__middle">
                        Сделана адаптивная верстка для корректного отображения на всех устройствах
                    </div>
                    <!-- END middle -->
                    ...
                    <div class="port-adapt__bottom">
                        <div class="port-adapt__proj">
                            <img src="/images/content/portfolio/project9/project-tablet.jpg" alt=""
                                 class="port-adapt__proj-tab">
                            <img src="/images/content/portfolio/project9/project-phone.jpg" alt=""
                                 class="port-adapt__proj-tab">
                        </div>
                    </div>
                    <!-- END bottom -->
