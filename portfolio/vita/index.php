        ...
        <div class="port vita">
            <section class="port-lap">
                ...
                <div class="port-lap__bgvideo">
                    <video autoplay muted loop class="port-lap__bgvideo-video" src="/images/content/portfolio/project7/videoplayback.mp4" poster="/images/content/portfolio/project7/bg.jpg">
                        <source src="/images/content/portfolio/project7/videoplayback.mp4" type="video/mp4">
                    </video>
                </div>
                            ...
                            <div class="port-lap__container">
                                ...
                                <div class="port-lap__before">
                                    ...
                                    <div class="port-lap__before-wrap">
                                        <img class="port-lap__img" src="/images/content/portfolio/project7/before.jpg">
                                    </div>
                                </div>
                                <div class="port-lap__after">
                                    <img class="port-lap__img" src="/images/content/portfolio/project7/after.jpg">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container3">
                ...
                <div class="port-desc">
                    ...
                    <div class="port-desc__logo">
                        <img class="port-desc__logo-img" src="/images/content/portfolio/project7/logo.png"></div>
                    <!-- END logo -->

                    <!-- title -->
                    <h1 class="port-desc__title">
                        Разработка сайта с мощным внутренним функционалом
                    </h1>
                    <!-- END title -->

                    <!-- subtitle -->
                    <div class="port-desc__sub">
                        Дополнительно реализовали интеграцию с сервисами доставки и оплаты через сайт, подключили синхронизацию остатков и выгрузили каталог на 50 000 наименований.
                    </div>
                    <!-- END subtitle -->
                        ...
                        <div class="swiper-container port-slider__container">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide port-slider__slide">
                                    <img class="port-slider__img" src="/images/content/portfolio/project7/slide1.jpg">
                                </div>
                                <div class="swiper-slide port-slider__slide">
                                    <img class="port-slider__img" src="/images/content/portfolio/project7/slide2.jpg">
                                </div>
                                <div class="swiper-slide port-slider__slide">
                                    <img class="port-slider__img" src="/images/content/portfolio/project7/slide3.jpg">
                                </div>
                                <div class="swiper-slide port-slider__slide">
                                    <img class="port-slider__img" src="/images/content/portfolio/project7/slide4.jpg">
                                </div>
                                <div class="swiper-slide port-slider__slide">
                                    <img class="port-slider__img" src="/images/content/portfolio/project7/slide5.jpg">
                                </div>
                                <div class="swiper-slide port-slider__slide">
                                    <img class="port-slider__img" src="/images/content/portfolio/project7/slide6.jpg">
                                </div>
                ...
                <div class="port-proj port-proj_1">
                    ...
                    <div class="port-proj__left">
                        <div class="port-proj__img">
                            <img class="port-proj__img-img" src="/images/content/portfolio/project7/project.jpg">
                        </div>
                    </div>
                    <!-- END left -->
                ...
                <div class="port-proj port-proj_2">
                    ...
                    <div class="port-proj__left">
                        <div class="port-proj__img">
                            <img class="port-proj__img-img" src="/images/content/portfolio/project7/project2.jpg">
                        </div>
                    </div>
                    <!-- END left -->
                ...
                <div class="port-proj port-proj_3">
                    ...
                    <div class="port-proj__left">
                        <div class="port-proj__img">
                            <img class="port-proj__img-img" src="/images/content/portfolio/project7/project3.jpg">
                        </div>
                    </div>
                    <!-- END left -->
