...
<main class="page page_second">
    ...
    <main class="main">
        <div class="port gazon">
            <section class="port-lap">
                <div class="port-lap__bgvideo">
                    <video autoplay muted loop class="port-lap__bgvideo-video"
                           src="/images/content/portfolio/project12/videoplayback.mp4"
                           poster="/images/content/portfolio/project12/bg.jpg">
                        <source src="/images/content/portfolio/project12/videoplayback.mp4" type="video/mp4">
                    </video>
                </div>
                            ...
                            <div class="port-lap__container">
                                ...
                                <div class="port-lap__before">
                                    ...
                                    <div class="port-lap__before-wrap"><img class="port-lap__img"
                                                                            src="/images/content/portfolio/project12/before.jpg">
                                    </div>
                                </div>
                                <div class="port-lap__after"><img class="port-lap__img"
                                                                  src="/images/content/portfolio/project12/after.jpg">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container3">
                ...
                <div class="port-desc">
                    ...
                    <div class="port-desc__logo">
                        <img class="port-desc__logo-img" src="/images/content/portfolio/project12/logo.png"></div>
                    <!-- END logo -->

                    <!-- title -->
                    <h1 class="port-desc__title">
                        Создание сайта по озеленению территорий
                    </h1>
                    <!-- END title -->

                    <!-- subtitle -->
                    <div class="port-desc__sub">
                        Разработка корпоративного сайта с каталогом товара, адаптивной версией для корректного отображения на всех устройствах. Дополнительно мы разработали визуальную структуру для каждой отдельной посадочной страницы.
                    </div>
                    <!-- END subtitle -->
                ...
                <div class="port-proj port-proj_1">
                    ...
                    <div class="port-proj__left">
                        <div class="port-proj__img">
                            <img class="port-proj__img-img" src="/images/content/portfolio/project12/project.jpg">
                        </div>
                    </div>
                    <!-- END left -->
                ...
                <div class="port-proj port-proj_2">
                    ...
                    <div class="port-proj__left">
                        <div class="port-proj__img">
                            <img class="port-proj__img-img" src="/images/content/portfolio/project12/project2.jpg">
                        </div>
                    </div>
                    <!-- END left -->
                ...
                <div class="port-proj port-proj_3">
                    ...
                    <div class="port-proj__left">
                        <div class="port-proj__img">
                            <img class="port-proj__img-img" src="/images/content/portfolio/project12/project3.jpg">
                        </div>
                    </div>
                    <!-- END left -->
                ...
                <div class="port-proj port-proj_4">
                    ...
                    <div class="port-proj__left">
                        <div class="port-proj__img">
                            <img class="port-proj__img-img" src="/images/content/portfolio/project12/project4.jpg">
                        </div>
                    </div>
                    <!-- END left -->
                ...
                <div class="port-adapt">
                        ...
                        <div class="port-adapt__list">
                            <div class="port-adapt__item">
                                ...
                                <div class="port-adapt__item-img">
                                    <img src="/images/content/portfolio/project12/tablet.png" alt=""
                            ...
                            <div class="port-adapt__item">
                                <!-- img -->
                                <div class="port-adapt__item-img">
                                    <img src="/images/content/portfolio/project12/phone.png" alt=""
                                         class="port-adapt__item-pic">
                                </div>
                                <!-- END img -->
                    ...
                    <div class="port-adapt__bottom">
                        <div class="port-adapt__proj">
                            <img src="/images/content/portfolio/project12/project-tablet.jpg" alt=""
                                 class="port-adapt__proj-tab">
                            <img src="/images/content/portfolio/project12/project-phone.jpg" alt=""
                                 class="port-adapt__proj-tab">
                        </div>
                    </div>
                    <!-- END bottom -->
