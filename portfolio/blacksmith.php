...
<main class="page page_second">
    ...
    <main class="main">
        <div class="port blacksmith">
            <section class="port-lap" style="background: url(/images/content/portfolio/project2/bg.jpg) 0 0 no-repeat;">
                    ...
                    <div class="port-proj__right">
                        ...
                        <div class="port-proj__block">
                            ...
                            <div class="port-proj__recom">
                                ...
                                <div class="port-proj__recom-desc">
                                    Можно ознакомится с видами покрытий кухоной гарнитуры, и добавить к заказу
                                    понравившийся
                                    вариант
                                </div>
                            </div>
                        ...
                        <div class="port-proj__block">
                            ...
                            <div class="port-proj__recom">
                                ...
                                <div class="port-proj__recom-desc">
                                    Пошаговая инструкция процесса работы. Были разработаны уникальные 3D иконки
                                </div>
                            </div>
                            <!-- END recom -->
                        </div>
