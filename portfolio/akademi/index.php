            ...
            <div class="container3">
                ...
                <div class="port-desc">
                    ...
                    <div class="port-desc__sub">
                        Разработка промосайта компании по оснащению офисов, <br>
                        с адаптивной версией для корректного отображения на всех устройствах. <br>
                        Сайт реализован в корпоративных цветах заказчика.
                    </div>
                    <!-- END subtitle -->
                    ...
                    <div class="port-slider__slider">
                        <div class="swiper-container port-slider__container">
                            <div class="swiper-wrapper">
                                ...
                                <div class="swiper-slide port-slider__slide">
                                    <img class="port-slider__img" src="/images/content/portfolio/project3/slide3.jpg">
                                </div>
                                <div class="swiper-slide port-slider__slide">
                                    <img class="port-slider__img" src="/images/content/portfolio/project3/slide4.jpg">
                                </div>
                                <div class="swiper-slide port-slider__slide">
                                    <img class="port-slider__img" src="/images/content/portfolio/project3/slide5.jpg">
                                </div>
                                <div class="swiper-slide port-slider__slide">
                                    <img class="port-slider__img" src="/images/content/portfolio/project3/slide6.jpg">
                                </div>
