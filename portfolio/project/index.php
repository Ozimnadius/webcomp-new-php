        ...
        <div class="port stroym">
                            ...
                            <div class="port-lap__container">
                                ...
                                <div class="port-lap__before">
                                    ...
                                    <div class="port-lap__before-wrap"><img class="port-lap__img"
                                                                            src="/images/content/portfolio/laptop/before.jpg">
                                    </div>
                                </div>
                                <div class="port-lap__after"><img class="port-lap__img"
                                                                  src="/images/content/portfolio/laptop/after.jpg">
                                </div>
                            </div>
                        </div>
                    </div>
            ...
            <div class="container3">
                <section class="port-desc" style="background: #363471;">
                    ...
                    <h1 class="port-desc__title">Разработка сайта в минималистичном стиле<br>с удобным функционалом
                    ...
                    <div class="port-desc__list numbers" data-timer="2000">
                        ...
                        <div class="port-desc__item number">
                            <div class="port-desc__item-title"><span class="number__val port-desc__item-val"
                                                                     data-from="0" data-to="42">0</span>
                            </div>
                            <div class="port-desc__item-text">дизайн-макетов</div>
                        </div>
                        <div class="port-desc__item number">
                            <div class="port-desc__item-title"><span class="number__val port-desc__item-val"
                                                                     data-from="0" data-to="126">0</span>
                            </div>
                    ...
                    <div class="port-slider__slider">
                        <div class="swiper-container port-slider__container">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide port-slider__slide"><img class="port-slider__img"
                                                                                  src="/images/content/portfolio/slider/slide1.jpg">
                                </div>
                                <div class="swiper-slide port-slider__slide"><img class="port-slider__img"
                                                                                  src="/images/content/portfolio/slider/slide2.jpg">
                                </div>
                                <div class="swiper-slide port-slider__slide"><img class="port-slider__img"
                                                                                  src="/images/content/portfolio/slider/slide3.jpg">
                                </div>
                                <div class="swiper-slide port-slider__slide"><img class="port-slider__img"
                                                                                  src="/images/content/portfolio/slider/slide1.jpg">
                                </div>
                ...
                <section class="port-pages" style="background: #363471;">
                    ...
                    <div class="port-pages__arrow"><img class="port-pages__arrow-img" src="/images/icons/arrow.png">
                    </div>
                    <div class="port-pages__imgs"><img class="port-pages__img"
                                                       src="/images/content/portfolio/pages.png"></div>
                </section>
