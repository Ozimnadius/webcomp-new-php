                            ...
                            <div class="port-lap__container">
                                ...
                                <div class="port-lap__before">
                                    ...
                                    <div class="port-lap__before-wrap"><img class="port-lap__img"
                                                                            src="/images/content/portfolio/project4/before.jpg">
                                    </div>
                                </div>
            ...
            <div class="container3">
                ...
                <div class="port-desc">
                    ...
                    <div class="port-desc__logo">
                        <img class="port-desc__logo-img" src="/images/content/portfolio/project4/logo.png"></div>
                    <!-- END logo -->
                    ...
                    <div class="port-desc__list numbers" data-timer="1000">
                        ...
                        <div class="port-desc__item number">
                            <div class="port-desc__item-title">
                                <span class="number__val port-desc__item-val" data-from="0" data-to="12">
                                    0
                                </span>
                            </div>
                        ...
                        <div class="swiper-container port-slider__container">
                            <div class="swiper-wrapper">
                                <div class="swiper-slide port-slider__slide">
                                    <img class="port-slider__img" src="/images/content/portfolio/project4/slide1.jpg">
                                </div>
                                <div class="swiper-slide port-slider__slide">
                                    <img class="port-slider__img" src="/images/content/portfolio/project4/slide2.jpg">
                                </div>
                                <div class="swiper-slide port-slider__slide">
                                    <img class="port-slider__img" src="/images/content/portfolio/project4/slide3.jpg">
                                </div>
                                <div class="swiper-slide port-slider__slide">
                                    <img class="port-slider__img" src="/images/content/portfolio/project4/slide4.jpg">
                                </div>
                                <div class="swiper-slide port-slider__slide">
                                    <img class="port-slider__img" src="/images/content/portfolio/project4/slide5.jpg">
                                </div>
                                <div class="swiper-slide port-slider__slide">
                                    <img class="port-slider__img" src="/images/content/portfolio/project4/slide6.jpg">
                                </div>
                ...
                <div class="port-icons">
                    ...
                    <div class="port-icons__icons">
                        <img class="port-icons__img" src="/images/content/portfolio/project4/icons.png">
                    </div>
                </div>
                <!-- END icons -->
                ...
                <div class="port-proj port-proj_1">
                    ...
                    <div class="port-proj__left">
                        <div class="port-proj__img">
                            <img class="port-proj__img-img" src="/images/content/portfolio/project4/project.jpg">
                        </div>
                    </div>
                    <!-- END left -->
                    ...
                    <div class="port-proj__right">
                        ...
                        <div class="port-proj__block">
                            ...
                            <div class="port-proj__list">
                                ...
                                <div class="port-proj__item">
                                    ...
                                    <div class="port-proj__item-desc">
                                        На этом экране мы показали и услуги и уникальное торговое предложение<br>
                        ...
                        <div class="port-proj__block">
                            ...
                            <div class="port-proj__list">
                                <div class="port-proj__item">
                                    <div class="port-proj__item-title">онлайн рассчёт
                                        <div class="port-proj__item-line"></div>
                                    </div>
                                    <div class="port-proj__item-desc">
                        ...
                        <div class="port-proj__block">
                            ...
                            <div class="port-proj__recom">
                                <div class="port-proj__recom-title">КАЛЬКУЛЯТОР
                ...
                <div class="port-pages">
                    ...
                    <div class="port-pages__arrow">
                        <img class="port-pages__arrow-img" src="/images/icons/arrow.png">
                    </div>
                    <div class="port-pages__imgs">
                        <img class="port-pages__img" src="/images/content/portfolio/project4/pages.png"></div>
                ...
                <div class="port-proj port-proj_2">
                    ...
                    <div class="port-proj__left">
                        <div class="port-proj__img">
                            <img class="port-proj__img-img" src="/images/content/portfolio/project4/project2.jpg">
                        </div>
                    </div>
                    <!-- END left -->
                    ...
                    <div class="port-proj__right">
                        ...
                        <div class="port-proj__block">
                            ...
                            <!-- END title -->
                            <div class="balconies__subtitle">
                                Категория остекление
                            </div>
                        </div>
                        <!-- END block 1-->
                        ...
                        <div class="port-proj__block">
                            ...
                            <div class="port-proj__list">
                                <div class="port-proj__item">
                                    <div class="port-proj__item-title">бонусы
                                        <div class="port-proj__item-line"></div>
                                    </div>
                                    <div class="port-proj__item-desc">
                ...
                <div class="port-adapt">
                        ...
                        <div class="port-adapt__list">
                            <div class="port-adapt__item">
                                ...
                                <div class="port-adapt__item-img">
                                    <img src="/images/content/portfolio/project4/tablet.png" alt=""
                            ...
                            <div class="port-adapt__item">
                                <!-- img -->
                                <div class="port-adapt__item-img">
                                    <img src="/images/content/portfolio/project4/phone.png" alt=""
                                         class="port-adapt__item-pic">
                                </div>
                                <!-- END img -->
                    ...
                    <div class="port-adapt__bottom">
                        <div class="port-adapt__proj">
                            <img src="/images/content/portfolio/project4/project-tablet.jpg" alt=""
                                 class="port-adapt__proj-tab">
                            <img src="/images/content/portfolio/project4/project-phone.jpg" alt=""
                                 class="port-adapt__proj-tab">
                        </div>
                    </div>
                    <!-- END bottom -->
