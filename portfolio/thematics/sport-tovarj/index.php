        ...
        <div class="rek subject">
                ...
                <div class="container">
                    <div class="rek-first__bread">
                        <div class="bread"><a class="bread__item" href="/">Создание сайтов</a>
                            ...
                            <a class="bread__item active">Сайт для спортивных товаров</a>
                        </div>
                    </div>
                    <div class="rek-first__title">Сайты спортивных тематик</div>
            ...
            <div class="container3">
                <section class="rek-desc">
                    <div class="rek-desc__title">Мы делаем спортивные сайты</div>
                    <div class="rek-desc__content content">
                        <div class="rek-desc__block">
							<p>Интернет-продвижение необходимо для эффективного развития бизнеса, поэтому уже на этапах разработки мы закладываем необходимый 
							функционал и прорабатываем структуру сайта для SEO. Сайт-каталог обеспечит стабильный приток клиентов, представит товары, услуги в 
							удобном формате. А спортивный сайт информационного типа, позволит осветить интересные события и привлечь аудиторию. Заказывая создание сайта спортивной тематики в нашей студии, вы получаете гарантию конечного результата. 
							Особое внимание при создании мы уделяем дизайну и удобной структуре сайта.</p>
							</div>
                        <div class="rek-desc__block">
                            <h3>Преимущества предложения Web-Comp:</h3>
                            <ul>
                              <li>Индивидуальный подход – потому что шаблонные решения не работают.
								Полное погружение в бизнес – сначала изучается работа заказчика, потом создается веб-дизайн.</li>
							  <li>Рост продаж – студия нацелена на конечный результат, поэтому гарантирует приток посетителей и повышение прибыли.</li>
							  <li>Хорошее юзабилити, дружелюбный интерфейс – интернет-магазин должен быть удобным.</li>
							  <li>Гибкий функционал – реализуются идеи разной сложности, услуги предоставляются «под ключ». </li>
							 </ul>
							<p>Предложение заинтересует производителей, оптовых поставщиков, стартапы. Чтобы заказать разработку торговой площадки, рассчитать цену проекта, отправьте онлайн-запрос.</p>
                        </div>
                        <div class="rek-desc__block">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide site-dev__slide" >
                                        ...
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/sport1.jpg">
                                        </div>
                                    </div>
                                    <div class="swiper-slide site-dev__slide" >
                                        <div class="proportion proportion_750x470"></div>
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/sport2.jpg">
                                        </div>
                                    </div>
                                    <div class="swiper-slide site-dev__slide" >
                                        <div class="proportion proportion_750x470"></div>
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/sport3.jpg">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <section class="theme-price">
                    <h1 class="theme-price__title">Стоимость создания сайта спортивных товаров</h1>
