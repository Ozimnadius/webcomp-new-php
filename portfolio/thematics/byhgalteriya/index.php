                ...
                <section class="rek-desc">
                    ...
                    <div class="rek-desc__content content">
                        <div class="rek-desc__block">
							...
							Часто нам приходится заниматься разработкой сайтов для бухгалтерии — крайне актуальной сферы, 
							специалистов из которой уже давно ищут практически исключительно в интернет-пространстве. 
							Создание такой площадки существенно упрощает коммуникацию между заказчиком и бухгалтерами, 
							которые оказывают услугу.</p>
                        </div>
                        <div class="rek-desc__block">
                            <h3>Особенности создания</h3>
							<p>Люди, которые хотят заказать сайт для бухгалтера, должны представлять себе его особенности, выделим несколько основных:</p>
                            <ul>
                                <li>Среди разделов, присутствующих на каждой веб-площадке: должным образом структурированное меню, список услуг, точная стоимость (прайс-лист), ключевые достоинства компании.</li>
                                <li>Полезным оказывается наличие раздела со статьями либо новостями.</li>
                                <li>Обязательны раздел с контактами и предоставление возможностей обратной связи.</li>
                                <li>Дизайн ресурса неизменно отличается сдержанностью и гармоничностью, соответствующей тематике. В цветовом оформлении применяются светлые и темные цвета, отсутствуют чрезмерно яркие и броские оттенки.</li>
								<li>Выжным дополнение к ресурсу являются блоки с отзывыми и сертификатами, подтверждающие квалификацию специалистов.</li>
                            </ul>
                        </div>
                        <div class="rek-desc__block">
							<p>Если вам требуется создать сайт для бухгалтерских услуг под ключ, будем рады сотрудничеству!</p>
                        </div>
                    </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide site-dev__slide" >
                                        ...
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/byhgalteriya1.jpg">
                                        </div>
                                    </div>
                                    <div class="swiper-slide site-dev__slide" >
                                        <div class="proportion proportion_750x470"></div>
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/byhgalteriya2.jpg">
                                        </div>
                                    </div>
                                    <div class="swiper-slide site-dev__slide" >
                                        <div class="proportion proportion_750x470"></div>
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/byhgalteriya3.jpg">
                                        </div>
                                    </div>
                                </div>
                            </div>
