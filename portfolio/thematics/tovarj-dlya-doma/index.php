                ...
                <section class="rek-desc">
                    ...
                    <div class="rek-desc__content content">
                        <div class="rek-desc__block">
							<p>Каталог – способ демонстрации товаров и услуг клиенту в удобном формате. По каталогу легко знакомиться с набором предложений и выбирать оптимальное. Создание сайта товаров для дома «под ключ» в студии предполагает подготовку рабочего бизнес решения. Вложенные средства в проектирование и разработку торговой площадки оправданы – люди активно покупают в интернете и говорят о многочисленных преимуществах онлайн-каталогов перед обычными.</p>
                        </div>
                        <div class="rek-desc__block">
                            <h3>Особенности услуги Web-Comp по созданию, продвижению сайтов:</h3>
                            <ul>
                                <li>Сжатые сроки реализации проекта – определяются с учетом особенностей текущих задач. Не затягиваем сдачу.</li>
                                <li>Комплексная проработка интерфейса, дизайна, рекламы – это делает проект на 100% эффективным.</li>
                                <li>Работа по подробному техническому заданию с изложением пожеланий клиента к конечному результату.</li>
                                <li>Предоставление гарантий, применение передовых инструментов интернет-маркетинга.</li>
								<li>Полное сопровождение ресурса после разработки.</li>
                            </ul>
                        </div>
                        <div class="rek-desc__block">
							<p>Заказать разработку интернет-магазин товаров для дома можно в один клик. Оставляйте запрос – и мы рассчитаем цену проекта.</p>
                        </div>
                    </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide site-dev__slide" >
                                        ...
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/tovarj-dlya-doma3 .png">
                                        </div>
                                    </div>
                                    <div class="swiper-slide site-dev__slide" >
                                        <div class="proportion proportion_750x470"></div>
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/tovarj-dlya-doma.png">
                                        </div>
                                    </div>
                                    <div class="swiper-slide site-dev__slide" >
                                        <div class="proportion proportion_750x470"></div>
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/tobarj-dlya-doma2.png">
                                        </div>
                                    </div>
                                </div>
                            </div>
