...
Решение заказать сайт для банка означает привлечение новых клиентов, расширение перечня услуг.
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide site-dev__slide" >
                                        ...
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/bank3.jpg">
                                        </div>
                                    </div>
                                    <div class="swiper-slide site-dev__slide" >
                                        <div class="proportion proportion_750x470"></div>
                                    ...
                                    <div class="swiper-slide site-dev__slide" >
                                        <div class="proportion proportion_750x470"></div>
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/bank2jpg">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <section class="rek-bud">
                    ...
                    <button class="rek-bud__button button promotionOpen" type="button">Узнайте индивидуальную стоимость сайта</button>
                </section>
            </div>
