        ...
        <div class="rek subject">
            ...
            <div class="container3">
                <section class="rek-desc">
                    <div class="rek-desc__title">Мы создаем сайты вызывающие интерес</div>
                    <div class="rek-desc__content content">
                        <div class="rek-desc__block">
                            <p>Правильно созданный веб-сайт для интернет-магазина позволяет в разы увеличить количество продаж и расширить круг потенциальных клиентов. Разработка сайта для продажи книг ведется по всем правилам, используются современные инструменты для улучшения продаж, максимально подробно на раннем этапе продумывается удобная навигация для будущего веб-ресурса.</p>
							<p>Тщательно продумывается будущий дизайн каждой страницы на портале, учитываются пожелания со стороны заказчика, такой подход позволяет реализовывать сложные проекты, не имеющие аналогов в интернете. Заказать сайт для презентации книг можно различного вида в зависимости от преследуемых целей:</p>
							<ul>
								<li>Небольшой каталог с описанием каждой группы продукции;</li>
								<li>Каталог в виде витрины с подробной аннотацией;</li>
								<li>Интернет-магазин с необходимыми инструментами для полноценного сбыта товаров в сети.</li>
							</ul>
						</div>
                        <div class="rek-desc__block">
							<p>Создание сайта для книги проводится по заранее намеченному плану. В компании работают профессиональные специалисты, готовые реализовать проекты любой степени сложности, удовлетворяющие все потребности заказчика. При работе с ресурсом применяются современные виджеты и плагины. В итоге клиент получает в свое распоряжение полноценный ресурс для презентации и реализации книжной продукции.</p>
                        </div>
                        <div class="rek-desc__block">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide site-dev__slide" >
                                        ...
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/knigi1.jpg">
                                        </div>
                                    </div>
                                    <div class="swiper-slide site-dev__slide" >
                                        <div class="proportion proportion_750x470"></div>
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/knigi2.jpg">
                                        </div>
                                    </div>
                                    <div class="swiper-slide site-dev__slide" >
                                        <div class="proportion proportion_750x470"></div>
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/knigi3.jpg">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <section class="theme-price">
                    <h1 class="theme-price__title">Стоимость создания сайта для книг</h1>
