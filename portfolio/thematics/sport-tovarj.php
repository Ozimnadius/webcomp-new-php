        ...
        <div class="rek subject">
            <section class="rek-first">
                <div class="container">
                    ...
                    <div class="rek-first__title">Интернет-магазин для спортивных товаров</div>
                ...
                <section class="rek-desc">
                    ...
                    <div class="rek-desc__content content">
                        <div class="rek-desc__block">
							<p>Интернет-продвижение необходимо для эффективного развития бизнеса, поэтому уже на этапах разработки мы закладываем необходимый функционал и прорабатываем структуру сайта для SEO. Сайт-каталог обеспечит стабильный приток клиентов, представит товары, услуги в удобном формате. Заказывая создание сайта для спортивных товаров в нашей студии, вы получаете гарантию конечного результата. Особое внимание при создании мы уделяем дизайну и удобной структуре сайта.</p>
							</div>
                        <div class="rek-desc__block">
