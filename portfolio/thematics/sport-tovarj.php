                ...
                <section class="rek-desc">
                    ...
                    <div class="rek-desc__content content">
                        <div class="rek-desc__block">
							<p>Интернет-продвижение необходимо для эффективного развития бизнеса. Сайт-каталог обеспечит стабильный приток клиентов, представит товары, услуги в удобном формате. Заказывая создание сайта для спортивных товаров в нашей студии, вы получаете окупаемый себя, продающий ресурс. Площадки разрабатываются на современных системах управления, оптимизированных под комплексное продвижение в поисковиках. </p>
                        </div>
                        <div class="rek-desc__block">
                            <h3>Преимущества предложения:</h3>
                            <ul>
                                <li>Индивидуальный подход – шаблонные решения не работают.Полное погружение в бизнес – сначала изучается работа заказчика, потом создается веб-дизайн.</li>
                                <li>Рост продаж – студия нацелена на конечный результат, поэтому гарантирует приток посетителей и повышение прибыли.</li>
                                <li>Удобное юзабилити, дружелюбный интерфейс – интернет-магазин должен быть интуитивно понятным. </li>
