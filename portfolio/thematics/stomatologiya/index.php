        ...
        <div class="rek subject">
                ...
                <div class="container">
                    <div class="rek-first__bread">
                        <div class="bread"><a class="bread__item" href="/">Создание сайтов</a>
                            ...
                            <a class="bread__item active">Сайт для стоматологической клиники</a>
                        </div>
                    </div>
                    <div class="rek-first__title">Сайт для стоматологической клиники</div>
            ...
            <div class="container3">
                <section class="rek-desc">
                    ...
                    <div class="rek-desc__content content">
                        <div class="rek-desc__block">
							<p>Без собственного сайта не обходится ни одна уважающая стоматологическая компания. Качественная площадка в интернете способна существенно повысить приток клиентов, подавляющее большинство которых сегодня ищут врача именно в поисковых системах. Наша фирма специализируется на создании сайтов для стоматологии под ключ (вы можете заказать разработку сайта для стоматолога либо стоматологической клиники).</p>
                        </div>
                        <div class="rek-desc__block">
                            <h3>Оращаем внимание при создании</h3>
							<p>Так как данный вид услуг вызывает беспокойство о клинтов стамотологических клиник, оснавная наша задача, которую мы ставим перед созданием сайта. Это придумать дизайн, вызывающий доверие и желание обратиться в компанию. После дизайна мы делаем упорт на информативность и размещаем следующие блоки:</p>
                            <ul>
                                <li>Информация о клинике или враче. Важно познакомить клиентов с историей клиники (или биографией врача), предоставить максимальное число гарантий (лицензии, разрешительная документация, положительные отзывы).</li>
                                <li>Полезная информация и рекомендации. Не стоит держать клиента на «информационной диете»: желательно максимально детально, подробно и притом лаконично рассказать о распространенных заболеваниях, способах их лечения, профилактических мерах</li>
                                <li>Визуальный контент. Нельзя ограничиваться текстом: на ресурсе должно быть определенное количество контента в формате фото либо видео (в идеале — оригинальных, а не взятых с интернета).</li>
                                <li>Прайс-лист. Клиент должен загодя знать точную стоимость всех услуг: это первая вещь, интересующая посетителя. Прайс-лист должен быть детальным и красиво оформленным.</li>
								<li>Коммуникация. Важно предоставить возможность связи в нескольких форматах.</li>
							</ul>
							<p>Обращайтесь в нашу компанию и мы создадим стабильный поток клиентов</p>
                        </div>
                    </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide site-dev__slide" >
                                        ...
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/stamat1.jpg">
                                        </div>
                                    </div>
                                    <div class="swiper-slide site-dev__slide" >
                                        <div class="proportion proportion_750x470"></div>
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/stamat2.jpg">
                                        </div>
                                    </div>
									 <div class="swiper-slide site-dev__slide" >
                                        <div class="proportion proportion_750x470"></div>
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/stamat3.jpg">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <section class="theme-price">
                    <h1 class="theme-price__title">Стоимость создания сайта для стоматологической клиники</h1>
