            ...
            <div class="container3">
                <section class="rek-desc">
                    ...
                    <div class="rek-desc__content content">
                        <div class="rek-desc__block">
							<p>Для повышения продуктивности работы автомобильному салону всегда требуется создать сайт, способный выступить наилучшим рекламным средством. Последнее обуславливает важность грамотного подхода к созданию: сайт для автосалона должен отвечать не только практическим, но и эстетическим требованиям, тем самым привлекая клиентов.</p>
                        </div>
                        <div class="rek-desc__block">
                            <p>Любая информационная площадка, ориентированная на продажу транспортных средств, должна включать в себя:</p>
                            <ul>
                                <li>Каталог - модельный ряд автомобилей с характеристиками и ценами.</li>
                                <li>Общая информация об автомобильном салоне (сюда относятся контактные данные, сотружники, документация).</li>
                                <li>Формы захвата контактных данных.</li>
                                <li>Блок с акциями и скидками.</li>
                            </ul>
                        </div>
                        <div class="rek-desc__block">
							<p>Если вы хотите создать сайт для автосалона, то заказать его вы можете по указанному в соответствующем разделе телефону. Будем рады сотрудничеству!</p>
                        </div>
                    </div>
                ...
                <section class="rek-bud">
                    ...
                    <div class="rek-bud__list numbers" data-timer="2000">
                        ...
                        <div class="rek-bud__item number">
                            <div class="rek-bud__item-title">
                                <span class="rek-bud__item-val number__val"  data-from="50" data-to="10">50</span><span class="rek-bud__item-type"> % bounce rate</span>
                            </div>
