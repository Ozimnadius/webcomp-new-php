        ...
        <div class="rek subject">
            ...
            <div class="container3">
                <section class="rek-desc">
                    ...
                    <div class="rek-desc__content content">
                        <div class="rek-desc__block">
                            <p>Хорошая строительная компания должна реализовывать работы на высшем уровне качества, 
							правильно предлагать услуги и материалы потенциальным заказчикам. Уважаемая фирма 
							без веб-сайта в сети не сможет, позволить посетителям легко находить интересующую 
							информацию или продукцию без звонка в офис. Создание сайта строительное тематике для предложения услуг или интернет-магазина для продажи строительных материалов проводится с нуля, 
							специалисты разрабатывают дизайн, удобную навигацию по ресурсу, продумывают наполнение для разделов. 
							В итоге клиент в свое распоряжение получает полноценный сайт с полным функционалом, не имеющий аналогов в сети.</p>
                            <p>Особое внимание мы уделяем:</p>
							<ul>
                                <li>В строительной тематике важно вызвать доверие у заказчика и показать, какой материал или услугу он поличит, поэтому мы максимально стараемся проработать страницы с педложением и разместить на них всю интересующую иноформацию;</li>
                                <li>Понятная и логичная структура сайта позволит быстро сориентироваться и понять основные преимущества компании;</li>
                                <li>Хороший запоминающийся дизайн мы всегда подкрепляем продающими текстами, которые отлично влияют на конверсию сайта.</li>
                            </ul>
                        </div>
                        <div class="rek-desc__block">
                            <p>Разработка строительных сайтов может проводиться по нашему индивидуальному проекту либо в зависимости от пожеланий заказчика. 
							Мы реализуем корпоративные сайты и интернет-магазины продажи строительнызх материалов любой сложности, делаем все возможное для того, чтобы готовый веб-ресурс полностью соответствовал потребностям и пожеланиям клиента. 
							</p>
                        </div>
                        <div class="rek-desc__block">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide site-dev__slide" >
                                        ...
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/stroimaterialj1.jpg">
                                        </div>
                                    </div>
                                    <div class="swiper-slide site-dev__slide" >
                                        <div class="proportion proportion_750x470"></div>
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/stroimaterialj2.jpg">
                                        </div>
                                    </div>
                                    <div class="swiper-slide site-dev__slide" >
                                        <div class="proportion proportion_750x470"></div>
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/stroimaterialj3.jpg">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <section class="theme-price">
                    <h1 class="theme-price__title">Стоимость создания сайта строительных материалов</h1>
