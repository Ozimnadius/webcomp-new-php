        ...
        <div class="rek subject">
                ...
                <div class="container">
                    <div class="rek-first__bread">
                        <div class="bread"><a class="bread__item" href="/">Создание сайтов</a>
                            ...
                            <a class="bread__item active">Сайт для деловых услуг</a>
                        </div>
                    </div>
                    <div class="rek-first__title">Сайт для деловых услуг</div>
                    <div class="rek-first__subtitle">
                        Комплексный подход к разработке вашего проекта <br>
                        с учётом особенностей вашего бизнеса<br>
            ...
            <div class="container3">
                <section class="rek-desc">
                    <div class="rek-desc__title">Мы умеем делать запоминающиеся сайты</div>
                    <div class="rek-desc__content content">
                        <div class="rek-desc__block">
                            <p>Залог постоянного роста продаж и среднего чека в сфере оказания бизнес услуг, 
							креативный сайт с презентацией компании или бизнес тренера. 
							Студия Web-comp предлагает взять на себя разработку и создание промо-сайта для оказания бизнес услуг под ключ, 
							чтобы вы смогли сконцентрироваться на том, в чем разбираетесь лучше — Организации бизнес-процессов ваших клиентов.</p>
							<p>Мы создаем лендинги и многостраничники, как для крупных фирмы, которые оказывают консалтинговые услуги, так и для частных бизнес тренеров или коучей. Над каждым проектом работаем поэтапно:</p>
                            <ul>
                                <li>изучаем рынок и ваших конкурентов;</li>
                                <li>делаем и согласовываем концепцию создания сайта;</li>
                                <li>реализовываем его в обозначенные договором сроки;</li>
                                <li>оптимизируем для дальнейшей раскрутки.</li>

                            </ul>
                        </div>
                        <div class="rek-desc__block">
                            <p>Для реализации подобного сайта будьте готовы предоставить информацию следующего характера: 
							Подробная информация о деятельности, сертификаты и заслуги, отзывы ваших клиентов, описание услуг и 
							ценовую политику, результаты вашей работы, информацию о вашей команде. Остальное мы всё сделаем за вас. 
							Вы получите многофункциональный ресурс, который послужит витриной предложений для целевой аудитории, 
							подтверждением вашего профессионализма, рекламной площадкой. Заказ сайта для оказания бизнес услуг — инвестиция, 
							которая обязательно не раз окупится, и при грамотном продвижении будет годами привлекать новых клиентов.</p>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide site-dev__slide" >
                                        ...
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/biznesyslygi1.jpg">
                                        </div>
                                    </div>
                                    <div class="swiper-slide site-dev__slide" >
                                        <div class="proportion proportion_750x470"></div>
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/biznesyslygi2.jpg">
                                        </div>
                                    </div>
                                    <div class="swiper-slide site-dev__slide" >
                                        <div class="proportion proportion_750x470"></div>
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/biznesyslygi3.jpg">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <section class="theme-price">
                    <h1 class="theme-price__title">Стоимость создания сайта для бизнес тематики</h1>
