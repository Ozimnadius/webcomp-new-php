                ...
                <div class="container">
                    <div class="rek-first__bread">
                        <div class="bread"><a class="bread__item" href="/">Создание сайтов</a>
                            ...
                            <a class="bread__item active">Сайт для продажи строительных товаров</a>
                        </div>
                    </div>
                    <div class="rek-first__title">Интернет-магазин для строительных материалов</div>
                ...
                <section class="rek-desc">
                    ...
                    <div class="rek-desc__content content">
                        <div class="rek-desc__block">
                            <p>Хорошая компания должна реализовывать работы на высшем уровне качества, 
							правильно предлагать услуги потенциальным заказчикам. Любая уважаемая фирма 
							должна иметь веб-сайт в сети, позволяющий посетителям легко находить интересующую 
							информацию или продукцию без звонка в офис. Создание интернет магазина для продажи строительных материалов проводится с нуля, 
							специалисты разрабатывают дизайн, удобную навигацию по ресурсу, продумывают наполнение для разделов. 
							В итоге клиент в свое распоряжение получает полноценный магазин с полным функционалом, не имеющий аналогов в сети.</p>
                            <p>Особое внимание мы уделяем:</p>
							<ul>
                                <li>В строительной тематике важно вызвать доверие у заказчика и показать, какой материал он поличит, поэтому мы максимально стараемся проработать страницы с товарам и разместить на них всю интересующую иноформацию;</li>
                        ...
                        <div class="rek-desc__block">
                            <p>Разработка интернет-магазина строительных материалов может проводиться по нашему индивидуальному проекту либо в зависимости от пожеланий заказчика. 
							Мы реализуем сайты любой сложности, делаем все возможное для того, чтобы готовый веб-ресурс полностью соответствовал потребностям и пожеланиям клиента. 
							</p>
                        </div>
                        <div class="rek-desc__block">
