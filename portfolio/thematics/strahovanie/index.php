        ...
        <div class="rek subject">
                ...
                <div class="container">
                    <div class="rek-first__bread">
                        <div class="bread"><a class="bread__item" href="/">Создание сайтов</a>
                            ...
                            <a class="bread__item active">Сайт для агентства страхования</a>
                        </div>
                    </div>
                    <div class="rek-first__title">Сайт для агентства страхования</div>
            ...
            <div class="container3">
                <section class="rek-desc">
                    ...
                    <div class="rek-desc__content content">
                        <div class="rek-desc__block">
                            <p>Часто страховые организации предлагают клиентам множество продуктов защиты жизни, здоровья, имущества от несчастных случаев. 
							Для упорядочивания страховок, упрощения процедуры выбора, стоит заказать сайт для страховых агентств. 
							Фирма имеет многолетний опыт работы в области создания различных веб-порталов. Оставьте заявку в режиме онлайн либо по телефону, 
							менеджер выслушает пожелания, подберет наиболее оптимальную схему для сотрудничества.<p>
 
                        </div>
                        <div class="rek-desc__block">
                            <h3>Создание сайта для страховщика под ключ имеет ряд преимуществ:</h3>
                            <ul>
                                <li>Клиенту достаточно озвучить основные требования к будущему порталу, дальнейшую разработку специалисты проведут самостоятельно;</li>
                                <li>Ресурс создается с нуля, прорабатываются все блоки, разделы для удобной навигации, поиска подходящего продукта;</li>
                                <li>Веб-сайт не имеет аналогов, копий в сети.</li>
                            </ul>
                        </div>
                        <div class="rek-desc__block">
                            <p>Разработка сайта для компании проводится по всем правилам. Клиент получает полностью работоспособный ресурс, 
							позволяющий повысить уровень продаж страховых продуктов. 
							Технические специалисты помогут решить непонятные моменты, дадут советы по поводу дальнейшего развития и продвижения.</p>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide site-dev__slide" >
                                        ...
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/strahovanie1.jpg">
                                        </div>
                                    </div>
                                    <div class="swiper-slide site-dev__slide" >
                                        <div class="proportion proportion_750x470"></div>
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/strahovanie2.jpg">
                                        </div>
                                    </div>
                                    <div class="swiper-slide site-dev__slide" >
                                        <div class="proportion proportion_750x470"></div>
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/strahovanie3.jpg">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <section class="theme-price">
                    <h1 class="theme-price__title">Стоимость создания сайта для агентства страхования</h1>
