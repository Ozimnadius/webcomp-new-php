        ...
        <div class="rek subject">
            ...
            <div class="container3">
                <section class="rek-desc">
                    ...
                    <div class="rek-desc__content content">
                        <div class="rek-desc__block">
                            <p>Около трети россиян ищут подрядчиков на ремонт квартир, офисов и технических помещений в интернете. 
							Отдавать такой громадный рынок целевой аудитории конкурентам опасно, 
							куда выгоднее заказать создание сайта для продажи услуг проведения ремонтов в 
							Web-comp и оказаться на шаг впереди тех, кто до сих пор не сделал этого.</p>
							<p>Собственный лендинг или многостраничник для компании, которая занимается отделкой и другими видами ремонтных работ послужит:</p>
                            <ul>
                                <li>портфолио для публикации фотографий завершенных объектов;</li>
                                <li>книгой отзывов, которые будут повышать уровень доверия потенциальных заказчиков;</li>
                                <li>рекламной площадкой, превосходящей по эффективности бумажные визитки и объявления.</li>
                            </ul>
							<br>
							<p>Разработка сайта по услугам ремонта проводится с упором на то, что каждая его страница должна работать на общую цель — получение заказов. 
							Для этого мы разработаем маркетинговую концепцию, проработаем структуру, заполним ключевые страницы информацией. 
							По завершении работ сайт будет полностью готов к продвижению и привлечению трафика при помощи контекстной рекламы. 
							Обращайтесь, подготовим для вас персональное коммерческое предложение.</p>
                        </div>
                    </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide site-dev__slide" >
                                        ...
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/stroitelstvo1.jpg">
                                        </div>
                                    </div>
                                    <div class="swiper-slide site-dev__slide" >
                                        <div class="proportion proportion_750x470"></div>
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/stroitelstvo2.jpg">
                                        </div>
                                    </div>
                                    <div class="swiper-slide site-dev__slide" >
                                        <div class="proportion proportion_750x470"></div>
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/stroitelstvo3.jpg">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <section class="theme-price">
                    <h1 class="theme-price__title">Стоимость создания сайта для строительной компании</h1>
