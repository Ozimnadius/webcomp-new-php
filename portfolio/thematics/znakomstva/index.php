        ...
        <div class="rek subject">
                ...
                <div class="container">
                    <div class="rek-first__bread">
                        <div class="bread"><a class="bread__item" href="/">Создание сайтов</a>
                            ...
                            <a class="bread__item active">Сайт для знакомств</a>
                        </div>
                    </div>
                    <div class="rek-first__title">Сайт для знакомств</div>
            ...
            <div class="container3">
                <section class="rek-desc">
                    <div class="rek-desc__title">Мы умеем знакомить людей</div>
                    <div class="rek-desc__content content">
                        <div class="rek-desc__block">
								<p>Площадка для знакомств – интернет-сервис, который создает все условия для комфортного 
								общения и быстрого чатинга. Через такую площадку можно искать вторую половинку или друзей, 
								общаться с понравившимися пользователями. Важно создать ресурс удобный для посетителей и максимально 
								простым для взаимодействия между пользователями. </p>
								<p>В данном разделе можно ознакомиться с особенностями ресурсов, узнать, сколько стоит создать сайт для знакомств «под ключ», оформить заявку.</p>
                        </div>
                        <div class="rek-desc__block">
						<p>Особое внимание при разработке мы уделяем:</p>
                            <ul>
                                <li>Проектирование структуры сайта.</li>
                                <li>Дизайн сайта.</li>
                                <li>Проработка личных кабинетов и функционал общения.</li>
                                <li>Бэкенд для удобного администрирования ресурса.</li>
								<li>Базовый функционал для маркетинга.</li>
                            </ul>
                        </div>
                        <div class="rek-desc__block">
							<p>Над проектом будет работать команда профессионалов, индивидуальный подход гарантирован. 
							Создаем продуманные интерфейсы, креативный дизайн, качественные административные панели. 
							Возможна реализация мультиязычных решений, интеграция любых дополнительных функций.</p>
							<p>Чтобы заказать разработку сайта, достаточно оставить заявку. Даем гарантию на все работы, осуществляем полное сопровождение ресурса.</p>
                        </div>
                    </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide site-dev__slide" >
                                        ...
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/znakomstva1.jpg">
                                        </div>
                                    </div>
                                    <div class="swiper-slide site-dev__slide" >
                                        <div class="proportion proportion_750x470"></div>
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/znakomstva2.jpg">
                                        </div>
                                    </div>
                                    <div class="swiper-slide site-dev__slide" >
                                        <div class="proportion proportion_750x470"></div>
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/znakomstva3.jpg">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <section class="theme-price">
                    <h1 class="theme-price__title">Стоимость создания сайта знакомств</h1>
