        ...
        <div class="rek subject">
                ...
                <div class="container">
                    <div class="rek-first__bread">
                        <div class="bread"><a class="bread__item" href="/">Создание сайтов</a>
                            ...
                            <a class="bread__item active">Сайт для салона красоты</a>
                        </div>
                    </div>
                    <div class="rek-first__title">Сайты для салона красоты</div>
            ...
            <div class="container3">
                <section class="rek-desc">
                    ...
                    <div class="rek-desc__content content">
                        <div class="rek-desc__block">
							<p>Главная особенность особенность нашей компании Web-Comp в том, что при создании веб-ресурсов мы учитываем не только специфику вашего бизнеса, но и потребности целевой аудитории. Это помогает нам разрабатывать сайты для салонов красоты, способствующие привлечению новых клиентов и увеличению продаж. </p>
                        </div>
                        <div class="rek-desc__block">
                            <h3>Что получают наши заказчики?</h3>
                            <p>Мы реализуем:</p>
							<ul>
                                <li>уникальный запоминающийся дизайн с учетом особенности заведения, его ценовой категории, спектра реализуемых услуг;</li>
                                <li>продуманную структуру и сделают удобную навигацию по сайту (посетителям не придется искать схему проезда или услуги);</li>
                                <li>удобные сервисы или функционал сайта;</li>
                                <li>наполним сайт контентом и материалами;</li>
								<li>разработаем стратегию рекламы в интернете.</li>
                            </ul>
                        </div>
                        <div class="rek-desc__block">
							<p>Заказывая создание сайта для СПА-салона красоты под ключ, вы получите удобный и функциональный ресурс, полностью соответствующий требованиям поисковых систем.</p>
							<p>Оставьте заявку на сайте. Мы свяжемся с вами и подробно расскажем об условиях сотрудничества.</p>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide site-dev__slide" >
                                        ...
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/salon-krasotj1.jpg">
                                        </div>
                                    </div>
                                    <div class="swiper-slide site-dev__slide" >
                                        <div class="proportion proportion_750x470"></div>
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/salon-krasotj2.jpg">
                                        </div>
                                    </div>
                                    <div class="swiper-slide site-dev__slide" >
                                        <div class="proportion proportion_750x470"></div>
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/salon-krasotj3.jpg">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <section class="theme-price">
                    <h1 class="theme-price__title">Стоимость создания сайта для салона красоты</h1>
