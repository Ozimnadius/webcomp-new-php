        ...
        <div class="rek subject">
                ...
                <div class="container">
                    <div class="rek-first__bread">
                        <div class="bread"><a class="bread__item" href="/">Создание сайтов</a>
                            ...
                            <a class="bread__item active">Сайт туристическ снаряжения</a>
                        </div>
                    </div>
                    <div class="rek-first__title">Сайт для туристического снаряжения</div>
            ...
            <div class="container3">
                <section class="rek-desc">
                    ...
                    <div class="rek-desc__content content">
                        <div class="rek-desc__block">
							<p>Ежегодно количество людей, которые интересуются туризмом растёт. 
							Статистика показывает, что люди всё больше предпочитают активный отдых на природе отдыху в отеле. 
							По этой причине актуальность создания сайта в туристической тематике также растёт. 
							Это может быть, как и информационный ресурс, который можно монетизировать за счёт рекламы, так и сайт, 
							предлагающий услуги или товар для туризма. </p>
                        </div>
                        <div class="rek-desc__block">
                            <p>Независимо от того, в каком направлении вы планируете развивать туристический сайт важно адаптировать площадку под требования аудитории, 
							а также заложить необходимой функционал на начальном этапе для продвижения ресурса. По статистике, бизнес в интернете развивается быстрее и 
							успешнее при наличии запоминающего дизайна и удобного функционала. Можно приобрести готовый ресурс, но площадка, созданная по шаблону, 
							не привлечет должного внимания. Кроме этого, при создании ресурса, посвященного туризму, следует учесть полезные для клиентов сервисы – покупка билетов, 
							бронирование номеров в отелях, аренда транспорта.</p>
							<p>Важно! Если тематическая виртуальная площадка нужна срочно, удобнее всего импортировать данные из справочников с описаниями гостиниц, курортов, государств.</p>
							<p>Что еще понадобится на ресурсе о туризме:</p>
                            <ul>
                                <li>календарь событий, праздников в разных странах;</li>
                                <li>погодные, климатические условия;</li>
                                <li>курсы валют;</li>
                                <li>карты, маршруты;</li>
								<li>интересные места, достопримечательности.</li>
                            </ul>
							<p>В нашей компании вы можете заказать сайт туристической тематики не зависимо какую функцию он выполняет продажу оборудования или предложение услуг. 
							Сайт будет отличаться удобством и функциональностью от аналогичных ресурсов и позволит быстро окупить затраты.</p>
                        </div>
                        <div class="rek-desc__block">
                        </div>
                    </div>
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide site-dev__slide" >
                                        ...
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/tyrizm1.jpg">
                                        </div>
                                    </div>
                                    <div class="swiper-slide site-dev__slide" >
                                        <div class="proportion proportion_750x470"></div>
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/tyrizm2.jpg">
                                        </div>
                                    </div>
                                    <div class="swiper-slide site-dev__slide" >
                                        <div class="proportion proportion_750x470"></div>
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/tyrizm3.jpg">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <section class="theme-price">
                    <h1 class="theme-price__title">Стоимость создания сайта для туристического снаряжения</h1>
