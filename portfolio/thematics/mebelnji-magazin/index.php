        ...
        <div class="rek subject">
            ...
            <div class="container3">
                <section class="rek-desc">
                    ...
                    <div class="rek-desc__content content">
                        <div class="rek-desc__block">
                            <p>Для успешного продвижения бизнеса, необходим качественный веб-ресурс. 
							Мастера студии Web-Comp предлагают разработку и создание сайта для магазина мебельной тематики. 
							Мы имеем большой опыт, в нашем портфолио десятки успешных проектов. 
							Клиенты гарантированно получат портал, который станет эффективным инструментом, позволяющим быстро продвинуть бизнес в Сети.</p>

                        </div>
                        <div class="rek-desc__block">
                            <h3>Этапы  создания мебельного магазина онлайн</h3>
                            <ul>
                                <li>анализ конкурентов и разработка концепции;</li>
                                <li>уникальный дизайн, обеспечивающий повышение лояльности ЦА;</li>
                                <li>верстка;</li>
                                <li>программирование с упором на скорость ресурса;</li>
								<li>установка необходимых сервисов (поиск  по параметрам, форма связи с менеджером, онлайн заказ и проч.);</li>
								<li>установка на хостинг.</li>
                            </ul>
							<p>Мы обязательно учитываем все важные моменты:</p>
							<ul>
								<li>ценовая категория товаров;</li>
								<li>потребности и особенности целевой аудитории;</li>
								<li>актуальные требования поисковиков.</li>
							</ul>
							<p>Мы также консультируем по вопросам наполнения, оптимизации контента, дальнейшего продвижения. В результате наши клиенты получают магазин, обеспечивающий стабильный рост продаж.</p>
							<p>Заказать сайт для мебельной компании можно, оформив заявку или связавшись с менеджерами по электронной почте. </p>
                        </div>
                        <div class="rek-desc__block">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide site-dev__slide" >
                                        ...
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/mebel1.jpg">
                                        </div>
                                    </div>
                                    <div class="swiper-slide site-dev__slide" >
                                        <div class="proportion proportion_750x470"></div>
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/mebel2.jpg">
                                        </div>
                                    </div>
                                    <div class="swiper-slide site-dev__slide" >
                                        <div class="proportion proportion_750x470"></div>
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/mebel3.jpg">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <section class="theme-price">
                    <h1 class="theme-price__title">Стоимость создания сайта для продажи мебели</h1>
