        ...
        <div class="rek subject">
                ...
                <div class="container">
                    <div class="rek-first__bread">
                        <div class="bread"><a class="bread__item" href="/">Создание сайтов</a>
                            ...
                            <a class="bread__item active">Сайт для свадебного агентства</a>
                        </div>
                    </div>
                    <div class="rek-first__title">Сайты для свадебного агентства</div>
            ...
            <div class="container3">
                <section class="rek-desc">
                    <div class="rek-desc__title">Мы создаем привлекающие внимание сайты</div>
                    <div class="rek-desc__content content">
                        <div class="rek-desc__block">
							<p>Подвенечное платье невесты, торжественный костюм жениха, мелкие, но важные детали, праздничные аксессуары – 
							в поисках всего, что нужно для роскошной свадьбы, молодожены сбиваются с ног. Создание сайта для свадебного салона – 
							неоценимая помощь тем, кто планирует ответственное событие в жизни.</p>
							<p>Ассортимент интернет-ресурса – это виртуальная площадка, где собраны товары, которые потребуются в такой знаменательный день. 
							По статистике, купить все по списку в одном магазине невозможно, приходится объездить немало торговых точек. 
							Совершать покупки в режиме онлайн, устроившись на диване, – быстро, удобно.</p>
							<p>Важно придерживаться сезонности. Большинство пар выбирают для бракосочетания теплое время года, задача интернет-ресурса привлечь как можно больше целевой аудитории в зимний сезон. Для этого используется система бонусов, акции и скидки.</p>
							
                        </div>
                        <div class="rek-desc__block">
                            <p>Если вы хотите организовать собственный бизнес и заказать сайт для свадебного салона, прежде всего, определитесь с его структурой. Традиционно ресурс состоит из таких разделов:</p>
								<ul>
								<li>общая информация, описание услуг;<li>
								<li>фотогалерея;</li>
								<li>прайс-лист;</li>
								<li>полезные рекомендации молодоженам.</li>
								</ul>
								<p>Необходимый этап продвижения бизнеса – интернет-реклама. Дело в том, что постоянных клиентов в данном направлении нет, 
								поэтому усилия нужно сконцентрировать на привлечении новых покупателей. Закажите создание свадебного интернет-магазина прямо сейчас, 
								вместе мы найдем максимально эффективное и успешное решение.</p>
                        </div>
                        <div class="rek-desc__block">
                                ...
                                <div class="swiper-wrapper">
                                    <div class="swiper-slide site-dev__slide" >
                                        ...
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/svadebnji-salon1.jpg">
                                        </div>
                                    </div>
                                    <div class="swiper-slide site-dev__slide" >
                                        <div class="proportion proportion_750x470"></div>
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/svadwbnji-salon2.jpg">
                                        </div>
                                    </div>
                                    <div class="swiper-slide site-dev__slide" >
                                        <div class="proportion proportion_750x470"></div>
                                        <div class="site-dev__slide-img">
                                            <img class="site-dev__slide-pic" src="/images/content/portfolio/thematics/svadebnji-salon3.jpg">
                                        </div>
                                    </div>
                                </div>
                            </div>
                ...
                <section class="theme-price">
                    <h1 class="theme-price__title">Стоимость создания сайта для свадебного агентства</h1>
