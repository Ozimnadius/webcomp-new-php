...
Note that the `vendor` folder and the `vendor/autoload/` script are generated by Composer; they are not part of PHPMailer.
...
require 'path/to/PHPMailer/src/PHPMailer/';
require 'path/to/PHPMailer/src/SMTP/';
```
...
While installing the entire package manually or with Composer is simple, convenient and reliable, you may want to include only vital files in your project. At the very least you will need [src/PHPMailer/](https://github.com/PHPMailer/PHPMailer/tree/master/src/PHPMailer/). If you're using SMTP, you'll need [src/SMTP/](https://github.com/PHPMailer/PHPMailer/tree/master/src/SMTP/), and if you're using POP-before SMTP, you'll need [src/POP3/](https://github.com/PHPMailer/PHPMailer/tree/master/src/POP3/). You can skip the [language](https://github.com/PHPMailer/PHPMailer/tree/master/language/) folder if you're not showing errors to users and can make do with English-only errors. If you're using XOAUTH2 you will need [src/OAuth/](https://github.com/PHPMailer/PHPMailer/tree/master/src/OAuth/) as well as the Composer dependencies for the services you wish to authenticate with. Really, it's much easier to use Composer!
...
We welcome corrections and new languages - if you're looking for corrections to do, run the [PHPMailerLangTest/](https://github.com/PHPMailer/PHPMailer/tree/master/test/PHPMailerLangTest/) script in the tests folder and it will show any missing translations.
...
Examples of how to use PHPMailer for common scenarios can be found in the [examples](https://github.com/PHPMailer/PHPMailer/tree/master/examples) folder. If you're looking for a good starting point, we recommend you start with [the Gmail example](https://github.com/PHPMailer/PHPMailer/tree/master/examples/gmail/s).
...
You can generate complete API-level documentation by running `phpdoc` in the top-level folder, and documentation will appear in the `docs` folder, though you'll need to have [PHPDocumentor](http://www/doc.org) installed. You may find [the unit tests](https://github.com/PHPMailer/PHPMailer/tree/master/test/phpmailerTest/) a good source of how to do various operations such as encryption.
