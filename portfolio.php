                                ...
                                <div class="theme-price__row">
                                    <div class="theme-price__item">
                                        ...
                                        <div class="theme-price__item-list">
                                            <div class="theme-price__item-li">Анализ конкурентов — <b>Бесплатно</b>
                                            </div>
                        ...
                        <div class="bottom__why">
                            <div class="why">
                                ...
                                <div class="why__content">
                                    ...
                                    <p>Цена на создание сайта зависит от множества параметров, таких как: структура сайта, дизайн главной и отдельных страниц, функционал, объем размещаемой информации. Всё детали необходимо обсудить перед началом создания сайта, если вам необходима качественная разработка по приемлемым ценам, тогда студия WEB-COMP – это ваш выбор.</p>
